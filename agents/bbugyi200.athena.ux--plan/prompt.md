#gh:gh_sase-org__sase The `sase ace` TUI crashes when I try to view an image file from the artifact panel that shows when the `a` keymap is used on the agents tab (e.g. this crash would occur if the user hit `<enter>` in #sshot). See the partial stacktrace below for context. Can you help me diagnose the root cause of this issue and fix it? #plan #m_opus 
```
│ ╭────────────────────────────────────────────────────────── locals ───────────────────────────────────────────────────────────╮                                                  │
