...
**Global name:** `bbugyi200.athena.sase-fq.5` · **State:** active · **Source run:** `run-7e88b62f462ce118195a381cd147ad3e`

**Owner:** `bbugyi200.athena` · **Project:** sase · **Hood:** sase-fq

## Summary

- Bead: [sase-fq.5](https://github.com/sase-org/sase--beads/blob/main/pages/sase-fq/sase-fq.5.md)
...
|---|---|---|---|
| sase | [`245d7c4`](https://github.com/sase-org/sase/commit/245d7c44fc12635f37b0d797c661ba6d1dd5b3ee) | ci: keep the prebuilt core wheel installed for every just recipe | 2026-08-06 01:39:05 UTC |
