%id(cld, clan=research.08) %wait(priority=20) %m:@research_b #gh:gh_sase-org__sase We currently support 8 different types of artifact references
...
IMPORTANT: Your goal is research only. Do NOT attempt to implement any of this. #research