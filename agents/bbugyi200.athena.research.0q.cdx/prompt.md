%clan(research.0q, tribe=research,
summary=[[[bold]RESEARCH PROMPT:[/bold] I want to make sase beats more powerful by making them
configurable via sase plugin hooks.
...
#gh:gh_sase-org__sase I want to make sase beats more powerful by making them
configurable via sase plugin hooks.
