...
**Global name:** `bbugyi200.athena.sase-bg.6` · **State:** active · **Source run:** `run-c55e609b3e83fd7eaf33079cd8d559b4`

**Owner:** `bbugyi200.athena` · **Project:** sase · **Hood:** sase-bg

## Summary

- Bead: [sase-bg.6](https://github.com/sase-org/sase--beads/blob/main/pages/sase-bg/sase-bg.6.md)
...
|---|---|---|---|
| sase | [`cf4088f`](https://github.com/sase-org/sase/commit/cf4088f751c30827fb016c17d3697bbc02fb6cdc) | feat!: replace bd/next with task bead workflow | 2026-07-30 19:11:54 EDT |
