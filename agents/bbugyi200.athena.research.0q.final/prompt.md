%id(final, clan=research.0q) %wait(priority=20) %m:@research_lead
%wait:research.0q.cdx %wait:research.0q.cld
...
I want to make sase beats more powerful by making them
