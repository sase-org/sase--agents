#gh:gh_sase-org__sase The `just install` command is failing for some reason (see the output below). Can you help me diagnose the root cause of this issue and fix it? #plan
```
