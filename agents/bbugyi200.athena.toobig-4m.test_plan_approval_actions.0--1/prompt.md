#fork:toobig-4m.test_plan_approval_actions.0
%model:grok-4.6
%effort:xhigh
...
**Why this was monitored:** Install missing sase_core_rs, then run just check after splitting tests/test_plan_approval_actions.py
