...
summary=[[[bold]RESEARCH PROMPT:[/bold] I've been improving sase's support for artifacts recently and
...
your analysis with a recommended solution.]]) %id:research.0r.cdx
%wait(priority=20) %model:@research_a 
#gh:gh_sase-org__sase I've been improving sase's support for artifacts recently and
generalizing / defining what an "artifact" exactly is. The next step I plan to take is
to add excellent support for linking artifacts to other artifacts.
