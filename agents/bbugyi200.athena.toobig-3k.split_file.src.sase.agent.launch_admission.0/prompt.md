#gh:sase-org/sase
%id:toobig-3k.split_file.src.sase.agent.launch_admission.0
%clan(toobig-3k, tribe=chop, summary=[[[bold #D75FFF]◆ TOOBIG SPLIT · 13 FILES[/bold #D75FFF]
[bold #87D7FF]MISSION[/bold #87D7FF]
[dim #D7D7FF]Decompose oversized Python modules into focused, reviewable units[/dim #D7D7FF]
[dim #D7D7FF]without changing behavior.[/dim #D7D7FF]

[bold #87D7FF]TARGETS[/bold #87D7FF]
[bold #FFAF5F]◆ 997  src/sase/agent/launch_admission.py[/bold #FFAF5F]
...
%model:@medium
%wait(runners=3)
%auto %wait(priority=20) #split_file:src/sase/agent/launch_admission.py