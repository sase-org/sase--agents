# Chat History - ace-run (y2--plan)

- **TIMESTAMP:** 2026-08-11 13:20:30 EDT
- **MODEL:** claude/opus
- **AGENT:** y2--plan

**Plan:** /home/bryan/.sase/plans/202608/artifact_ref_contract.md


## Prompt

#gh:gh_sase-org__sase We currently support 8 different types of artifact references (referred to as
"refs" for the rest of this prompt)--the 6 builtin ones + `@plan` and `@research`. These
are all supposedly defined using xprompts (see the sase-ho epic bead for context). I
want to revert a lot of the work associated with the sase-ho epic bead and re-design
refs. Can you help me implement the changes described below?
...
**Plan file:** `/home/bryan/.sase/plans/202608/artifact_ref_contract.md`
