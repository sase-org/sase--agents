...
thread '<unnamed>' (116976) panicked at crates/sase_core/src/provider_priority.rs:1609:18:
called `Result::unwrap()` on an `Err` value: LockTimeout
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

thread '<unnamed>' (116977) panicked at crates/sase_core/src/provider_priority.rs:1609:18:
called `Result::unwrap()` on an `Err` value: LockTimeout

thread 'provider_priority::tests::concurrent_priority_changes_and_auto_disables_are_serialized' (116974) panicked at crates/sase_core/src/provider_priority.rs:1637:41:
...
test result: FAILED. 2654 passed; 1 failed; 0 ignored; 0 measured; 0 filtered out; finished in 19.26s

error: test failed, to rerun pass `-p sase_core --lib`
sase-core cargo test --workspace failed; isolating known provider_priority LockTimeout flake and re-running the rest
    Finished `test` profile [unoptimized + debuginfo] target(s) in 0.29s
     Running unittests src/lib.rs (/home/bryan/.cache/sase/tmp/build-targets/cargo-d6/4d83442804209f/debug/deps/sase_core-96da995d7c90a95c)
...
thread '<unnamed>' (120667) panicked at crates/sase_core/src/provider_priority.rs:1609:18:
called `Result::unwrap()` on an `Err` value: LockTimeout
note: run with `RUST_BACKTRACE=1` environment variable to display a backtrace

thread '<unnamed>' (120665) panicked at crates/sase_core/src/provider_priority.rs:1609:18:
called `Result::unwrap()` on an `Err` value: LockTimeout

thread '<unnamed>' (120666) panicked at crates/sase_core/src/provider_priority.rs:1609:18:
called `Result::unwrap()` on an `Err` value: LockTimeout

thread 'provider_priority::tests::concurrent_priority_changes_and_auto_disables_are_serialized' (120628) panicked at crates/sase_core/src/provider_priority.rs:1637:41:
called `Result::unwrap()` on an `Err` value: Any { .. }
...
test result: FAILED. 0 passed; 1 failed; 0 ignored; 0 measured; 2654 filtered out; finished in 1.13s
