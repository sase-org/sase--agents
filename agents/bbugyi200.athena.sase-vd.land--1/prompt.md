...
**Why this was monitored:** Landing gate for epic sase-vd (One workspace per agent family) on the combined tree, including the land agent's git_setup claim-identity fix
