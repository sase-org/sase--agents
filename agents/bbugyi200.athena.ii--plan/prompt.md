#gh:gh_sase-org__sase When I attempt to kill and edit the `sase-8k.2` agent, which lives in the `sase-8k` agent clan, I receive the below error when `sase ace` crashes. Can you help me diagnose the root cause of this issue and fix it? #plan #m_opus
```
