...
**Global name:** `bbugyi200.athena.sase-fq.3` · **State:** active · **Source run:** `run-7aca33732994d702feccd8de06525f58`

**Owner:** `bbugyi200.athena` · **Project:** sase · **Hood:** sase-fq

## Summary

- Bead: [sase-fq.3](https://github.com/sase-org/sase--beads/blob/main/pages/sase-fq/sase-fq.3.md)
...
|---|---|---|---|
| sase | [`260ea5a`](https://github.com/sase-org/sase/commit/260ea5a0d99d536fcb38d30ea51270c5b775bfa7) | fix(tests): give the git-sync sidecar clone a committer identity | 2026-08-06 01:19:11 UTC |
