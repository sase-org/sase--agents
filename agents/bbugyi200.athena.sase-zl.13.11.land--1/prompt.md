...
**Why this was monitored:** Landing gate for epic sase-zl.13.11: full lint + complete test suite over the combined tree (core pin ratcheted to b598337, flaky combined-route assert fixed)
