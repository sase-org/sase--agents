#gh:gh_sase-org__sase Can you help me make this command more resilient and reliable by automatically handling this type of error in the appropriate way in the future (see the command output below for context)? #plan %m:@xlarge
```
