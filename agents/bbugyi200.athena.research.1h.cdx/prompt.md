#gh:gh_sase-org__sase %clan(research.1h, tribe=research,
...
#beau End your analysis with a recommended solution.]]) %id:research.1h.cdx
%model:@research_a 
You are researcher A in a two-researcher swarm. The other researcher,
`research.1h.cld`, is independently investigating the same request and will write its
