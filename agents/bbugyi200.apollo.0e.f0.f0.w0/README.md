...
**Global name:** `bbugyi200.apollo.0e.f0.f0.w0` · **State:** waiting · **Source run:** `run-d29cedd43d12fc06ffa31a2effdb1c11`
...
|---|---|---|
| [0e.f0.f0](../../families/bbugyi200.apollo.0e.f0.f0.md) (family · 7) | ancestor | active 1, completed 3, failed 3 |
