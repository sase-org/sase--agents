# Chat History - ace-run (sase-m9.2.1.6.land--mon-0)

- **TIMESTAMP:** 2026-08-15 13:39:17 EDT
- **MODEL:** codex/gpt-5.5
- **AGENT:** sase-m9.2.1.6.land--mon-0

## Prompt

sase monitor start --command 'just check-full' --reason 'Rerun exhaustive verification after fixing notification snooze timestamp regression caught by check-full'
...
scoped runs recorded:   1022
  escalated to full:    606 (59.3%)
  median selected:      138 (5.2% of 2667)
  p90 selected:         786 (29.5% of 2667)
  median duration:      119.7s
  p75 duration:         353.2s
  p90 duration:         510.5s
  max duration:         1628.5s
full-lane runs recorded: 1017

worker-seconds avoided vs. running the full suite instead: 1,219,046 (~20,317 worker-minutes, at 3,650s per full run)

broadening rules fired:
   402  context-baseline-stale
   260  context-selection
   449  contract-set-always
    95  contract-set-only
   382  core-identity-changed
     5  directory-conftest
   121  justfile
   402  no-baseline-depth-boost
    51  packaging-config
    69  rename-or-delete
    35  root-conftest
    39  selection-tooling
   230  serial-budget-exceeded
   130  src-data-asset
...
scoped runs slower than the full lane (232.0s): 147 of 1022
  606 escalated run(s) not counted here: cost not measured (handed off to the full lane before the runner could time it)
  ...
  20260814T223311Z-191e9f219683-3447959.json: 590.6s at 4 workers, 791 file(s) selected, rules: context-baseline-stale, context-selection, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
  ...
  20260814T222057Z-191e9f219683-3311016.json: 512.1s at 4 workers, 791 file(s) selected, rules: context-baseline-stale, context-selection, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
  ...
  20260815T145638Z-6683d4bcc25c-3833608.json: 496.3s at 4 workers, 207 file(s) selected, rules: context-baseline-stale, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
  ...
  20260815T005616Z-4280bc990c59-1142471.json: 470.2s at 4 workers, 858 file(s) selected, rules: context-baseline-stale, context-selection, contract-set-always, no-baseline-depth-boost, rename-or-delete, serial-budget-exceeded
  ...
  20260814T235136Z-a09a5c12909e-433584.json: 466.8s at 4 workers, 846 file(s) selected, rules: context-baseline-stale, context-selection, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
  20260815T004429Z-4280bc990c59-1051240.json: 466.1s at 4 workers, 857 file(s) selected, rules: context-baseline-stale, context-selection, contract-set-always, no-baseline-depth-boost, rename-or-delete, serial-budget-exceeded
  ...
  20260815T115621Z-2f9b59cadb2a-1755271.json: 450.0s at 4 workers, 634 file(s) selected, rules: context-baseline-stale, context-selection, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
  ...
  20260815T031129Z-7060a2ec45dc-2351614.json: 386.3s at 4 workers, 398 file(s) selected, rules: context-baseline-stale, context-selection, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
  20260815T105935Z-6f027ae6b499-788707.json: 378.7s at 4 workers, 367 file(s) selected, rules: context-baseline-stale, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
  ...
  20260815T023649Z-7060a2ec45dc-2121414.json: 369.6s at 4 workers, 398 file(s) selected, rules: context-baseline-stale, context-selection, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
  20260815T024740Z-7060a2ec45dc-2238423.json: 368.2s at 4 workers, 398 file(s) selected, rules: context-baseline-stale, context-selection, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
  ...
  20260815T105108Z-6f027ae6b499-657426.json: 361.5s at 4 workers, 367 file(s) selected, rules: context-baseline-stale, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
  ...
  20260815T002256Z-4280bc990c59-771086.json: 314.4s, 226 file(s) selected, rules: context-baseline-stale, contract-set-always, no-baseline-depth-boost
  ...
  20260815T132310Z-1e242aa8b9e8-2648865.json: 277.2s at 4 workers, 781 file(s) selected, rules: context-baseline-stale, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
  ...
  20260815T161637Z-435cb34df1e5-1008990.json: 266.5s at 4 workers, 342 file(s) selected, rules: context-baseline-stale, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
  ...
  20260815T131445Z-1e242aa8b9e8-2585255.json: 253.1s at 4 workers, 781 file(s) selected, rules: context-baseline-stale, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
  ...
  20260815T160828Z-435cb34df1e5-887437.json: 250.6s at 4 workers, 342 file(s) selected, rules: context-baseline-stale, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
...
middle gear: 197 run(s) leased a bounded width, 33 refused and escalated instead
  timed runs by width: 219 at 1 worker, 4 at 3 workers, 193 at 4 workers
  the durations above pool these widths; a wide run's wall clock is not a serial one's

coverage contexts:
  runs that consulted it: 449 of 1022 (573 escalated before it mattered)
  runs with a baseline:  447 of 449
  runs without one:      2 (static closure alone)
  runs on a stale one:   402
  test files contributed: 19186 (cumulative)

false negatives: 1951 (4086 scoped run/failure matches)
  ...
  tests/ace/tui/test_artifacts_bead_plan_jump.py::test_plans_open_bead_clears_filter_and_selects_closed_bead
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/test_artifacts_beads_filtering.py::test_filter_index_reuses_unchanged_snapshot_source_key
    failed in 20260815T140311Z-8b4635ad13e8-3240767-full-run.json (head 8b4635ad13e8)
  ...
  tests/ace/tui/test_artifacts_list_navigation.py::test_configured_navigation_actions_route_to_non_pr_list
    failed in 20260810T203904Z-64ddea98a879-2986364-full-run.json (head 64ddea98a879)
    excluded by 25 scoped run(s), first 20260810T172630Z-3eddffba9232-3254141.json (head 3eddffba9232)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/ace/tui/test_changespec_detail_only_refresh.py::test_mark_toggle_calls_patch_patch_row_once_no_clear_options
    failed in 20260814T225401Z-191e9f219683-3843313-full-run.json (head 191e9f219683)
  ...
  tests/ace/tui/test_changespec_detail_only_refresh.py::test_mark_toggle_falls_back_to_full_refresh_on_patch_failure
    failed in 20260808T232939Z-bcf5748b6bf7-1051423-full-run.json (head bcf5748b6bf7)
    excluded by 8 scoped run(s), first 20260806T163604Z-a15f409dd113-2188655.json (head a15f409dd113)
    distinct change sets: 2
    matched across unrelated changes; suspect a flake before a miss
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/ace/tui/test_commits_pane_collection.py::test_explicit_limit_truncates_and_remains_visible
    failed in 20260810T203904Z-64ddea98a879-2986364-full-run.json (head 64ddea98a879)
    excluded by 17 scoped run(s), first 20260810T172630Z-3eddffba9232-3254141.json (head 3eddffba9232)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/test_commits_pane_collection.py::test_sidecar_filter_and_compatibility_toggle_share_collection_scope
    failed in 20260810T203904Z-64ddea98a879-2986364-full-run.json (head 64ddea98a879)
    excluded by 33 scoped run(s), first 20260810T172630Z-3eddffba9232-3254141.json (head 3eddffba9232)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/test_commits_pane_collection.py::test_unchanged_relative_query_reuses_cache_and_refreshes_its_clock
    failed in 20260810T203904Z-64ddea98a879-2986364-full-run.json (head 64ddea98a879)
    excluded by 41 scoped run(s), first 20260810T172630Z-3eddffba9232-3254141.json (head 3eddffba9232)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/ace/tui/test_copy_targets.py::test_copy_target_registry_exactly_covers_default_keymap_targets
    failed in 20260808T232939Z-bcf5748b6bf7-1051423-full-run.json (head bcf5748b6bf7)
    excluded by 10 scoped run(s), first 20260806T163604Z-a15f409dd113-2188655.json (head a15f409dd113)
    distinct change sets: 2
    matched across unrelated changes; suspect a flake before a miss
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/ace/tui/test_launch_repeat_bulk.py::test_bulk_launch_takes_changespec_snapshot
    ...
    distinct change sets: 1
    rules across those runs: contract-set-always
  tests/ace/tui/test_launch_repeat_bulk.py::test_bulk_launch_takes_patch_snapshot
    failed in 20260814T225401Z-191e9f219683-3843313-full-run.json (head 191e9f219683)
    excluded by 6 scoped run(s), first 20260806T185529Z-8fcc2520fb17-132917.json (head 8fcc2520fb17)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/llm_provider/test_temporary_override_phase2.py::test_invoke_agent_applies_active_override
    failed in 20260815T164952Z-8902cb5e5eea-1438796-full-run.json (head 8902cb5e5eea)
    excluded by 16 scoped run(s), first 20260808T004614Z-7bbd82a47ed7-1287209.json (head 7bbd82a47ed7)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/llm_provider/test_temporary_override_phase2.py::test_invoke_agent_prompt_directive_beats_override
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/main/test_artifact_handler.py::test_parser_registers_canonical_group_alias_and_all_subcommands
    failed in 20260815T013556Z-2265f2618c14-1698174-full-run.json (head 2265f2618c14)
    excluded by 8 scoped run(s), first 20260808T004614Z-7bbd82a47ed7-1287209.json (head 7bbd82a47ed7)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/main/test_parser_narrowing.py::test_patch_parser_supports_canonical_command_and_legacy_alias[patch1]
    ...
    matched across unrelated changes; suspect a flake before a miss
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/main/test_parser_proc.py::test_proc_status_choices_match_the_store_lifecycle
    failed in 20260815T104020Z-6f027ae6b499-556287-full-run.json (head 6f027ae6b499)
    excluded by 6 scoped run(s), first 20260806T185529Z-8fcc2520fb17-132917.json (head 8fcc2520fb17)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_bead/test_epic_jit_claim_integration.py::test_wait_claim_survives_publication_lag_and_holds_until_promotion
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, context-selection, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
  tests/test_bead/test_epic_launch.py::test_start_epic_launch_monitor_fallback_deduplicates_active_resolved_plan
    failed in 20260815T104020Z-6f027ae6b499-556287-full-run.json (head 6f027ae6b499)
    excluded by 6 scoped run(s), first 20260806T185529Z-8fcc2520fb17-132917.json (head 8fcc2520fb17)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_bead/test_task_gate_actions.py::test_task_triage_launch_executes_real_command_translates_and_persists_task_id
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_bead/test_task_launch.py::test_active_task_launch_bead_ids_returns_active_task_bead_launches
    failed in 20260815T104020Z-6f027ae6b499-556287-full-run.json (head 6f027ae6b499)
    excluded by 6 scoped run(s), first 20260806T185529Z-8fcc2520fb17-132917.json (head 8fcc2520fb17)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_bead/test_task_launch.py::test_submit_task_launch_task_deduplicates_active_bead_id
    failed in 20260815T104020Z-6f027ae6b499-556287-full-run.json (head 6f027ae6b499)
    excluded by 6 scoped run(s), first 20260806T185529Z-8fcc2520fb17-132917.json (head 8fcc2520fb17)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_command_availability_changespecs.py::test_app_edit_query_is_available_on_artifact_filters_and_axe
    failed in 20260815T004922Z-4280bc990c59-1156826-full-run.json (head 4280bc990c59)
    excluded by 6 scoped run(s), first 20260806T185529Z-8fcc2520fb17-132917.json (head 8fcc2520fb17)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_command_availability_changespecs.py::test_plans_filter_command_is_available_only_on_plans
    failed in 20260808T232939Z-bcf5748b6bf7-1051423-full-run.json (head bcf5748b6bf7)
    excluded by 9 scoped run(s), first 20260806T163604Z-a15f409dd113-2188655.json (head a15f409dd113)
    distinct change sets: 2
    matched across unrelated changes; suspect a flake before a miss
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_command_context_extraction.py::test_extract_context_changespecs_tab_picks_selected_cs
    ...
    distinct change sets: 1
    rules across those runs: contract-set-always
  tests/test_command_context_extraction.py::test_extract_context_patches_tab_picks_selected_cs
    failed in 20260814T225401Z-191e9f219683-3843313-full-run.json (head 191e9f219683)
    excluded by 6 scoped run(s), first 20260806T185529Z-8fcc2520fb17-132917.json (head 8fcc2520fb17)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_core_agent_scan_records_workflow.py::test_workflow_state_hidden_is_parsed
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_core_agent_scan_wire.py::test_agent_meta_clan_field_order_matches_rust_wire
    failed in 20260815T130157Z-1e242aa8b9e8-2446223-full-run.json (head 1e242aa8b9e8)
    excluded by 6 scoped run(s), first 20260806T185529Z-8fcc2520fb17-132917.json (head 8fcc2520fb17)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_core_facade/test_bead_read.py::test_doctor_reads_jsonl_without_requiring_sqlite
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, context-selection, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
  tests/test_core_facade/test_notification_store.py::test_real_extension_round_trips_bulk_mute_and_snooze
    failed in 20260815T114237Z-2f9b59cadb2a-1638919-full-run.json (head 2f9b59cadb2a)
    excluded by 8 scoped run(s), first 20260808T004614Z-7bbd82a47ed7-1287209.json (head 7bbd82a47ed7)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_keymaps_app_bindings.py::test_fallback_bindings_match_numbered_artifacts_and_saved_query_picker
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_keymaps_defaults.py::test_copy_mode_dataclass_defaults_match_default_config
    failed in 20260815T013556Z-2265f2618c14-1698174-full-run.json (head 2265f2618c14)
    excluded by 8 scoped run(s), first 20260808T004614Z-7bbd82a47ed7-1287209.json (head 7bbd82a47ed7)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_llm_provider_invoke.py::test_invoke_agent_execution_provider_override_preserves_requested_metadata
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_llm_provider_invoke.py::test_invoke_agent_no_directive_routes_through_configured_default_alias
    failed in 20260815T164952Z-8902cb5e5eea-1438796-full-run.json (head 8902cb5e5eea)
    excluded by 16 scoped run(s), first 20260808T004614Z-7bbd82a47ed7-1287209.json (head 7bbd82a47ed7)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_procs_facade.py::test_kind_filter_selects_one_or_many_proc_kinds
    failed in 20260815T113113Z-2f9b59cadb2a-1415066-full-run.json (head 2f9b59cadb2a)
    excluded by 16 scoped run(s), first 20260808T004614Z-7bbd82a47ed7-1287209.json (head 7bbd82a47ed7)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_procs_runner.py::test_store_kill_rejects_tui_owned_procs
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_query_profile_corpus_facade.py::test_cache_key_is_sensitive_to_generation_profile_and_query
    failed in 20260815T134437Z-8b4635ad13e8-2921048-full-run.json (head 8b4635ad13e8)
    excluded by 2 scoped run(s), first 20260810T222227Z-0ccd7f844731-800799.json (head 0ccd7f844731)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_query_profile_corpus_facade.py::test_compile_index_and_evaluate_matches_expected_rows
    failed in 20260815T134437Z-8b4635ad13e8-2921048-full-run.json (head 8b4635ad13e8)
    excluded by 2 scoped run(s), first 20260810T222227Z-0ccd7f844731-800799.json (head 0ccd7f844731)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_query_profile_corpus_facade.py::test_flat_parse_and_canonicalize_through_rust_match_python_reference[kind:file-False]
    failed in 20260815T134437Z-8b4635ad13e8-2921048-full-run.json (head 8b4635ad13e8)
    excluded by 2 scoped run(s), first 20260810T222227Z-0ccd7f844731-800799.json (head 0ccd7f844731)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_query_profile_corpus_facade.py::test_flat_parse_and_canonicalize_through_rust_match_python_reference[status:open-True]
    failed in 20260815T134437Z-8b4635ad13e8-2921048-full-run.json (head 8b4635ad13e8)
    excluded by 2 scoped run(s), first 20260810T222227Z-0ccd7f844731-800799.json (head 0ccd7f844731)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_query_profile_corpus_facade.py::test_observed_facets_report_distinct_filterable_values
    failed in 20260815T134437Z-8b4635ad13e8-2921048-full-run.json (head 8b4635ad13e8)
    excluded by 2 scoped run(s), first 20260810T222227Z-0ccd7f844731-800799.json (head 0ccd7f844731)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_query_profile_corpus_facade.py::test_parse_and_canonicalize_through_rust_match_python_reference[!!]
    failed in 20260815T134437Z-8b4635ad13e8-2921048-full-run.json (head 8b4635ad13e8)
    excluded by 2 scoped run(s), first 20260810T222227Z-0ccd7f844731-800799.json (head 0ccd7f844731)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_query_profile_corpus_facade.py::test_parse_and_canonicalize_through_rust_match_python_reference["example"]
    failed in 20260815T134437Z-8b4635ad13e8-2921048-full-run.json (head 8b4635ad13e8)
    excluded by 2 scoped run(s), first 20260810T222227Z-0ccd7f844731-800799.json (head 0ccd7f844731)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_query_profile_corpus_facade.py::test_parse_and_canonicalize_through_rust_match_python_reference[%w]
    failed in 20260815T134437Z-8b4635ad13e8-2921048-full-run.json (head 8b4635ad13e8)
    excluded by 2 scoped run(s), first 20260810T222227Z-0ccd7f844731-800799.json (head 0ccd7f844731)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_query_profile_corpus_facade.py::test_parse_and_canonicalize_through_rust_match_python_reference[+sase]
    failed in 20260815T134437Z-8b4635ad13e8-2921048-full-run.json (head 8b4635ad13e8)
    excluded by 2 scoped run(s), first 20260810T222227Z-0ccd7f844731-800799.json (head 0ccd7f844731)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_query_profile_corpus_facade.py::test_parse_and_canonicalize_through_rust_match_python_reference[name:example]
    failed in 20260815T134437Z-8b4635ad13e8-2921048-full-run.json (head 8b4635ad13e8)
    excluded by 2 scoped run(s), first 20260810T222227Z-0ccd7f844731-800799.json (head 0ccd7f844731)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_query_profile_corpus_facade.py::test_provider_profile_index_matches_python_reference
    failed in 20260815T134437Z-8b4635ad13e8-2921048-full-run.json (head 8b4635ad13e8)
    excluded by 2 scoped run(s), first 20260810T222227Z-0ccd7f844731-800799.json (head 0ccd7f844731)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_query_profile_corpus_facade.py::test_rust_facade_matches_python_reference_evaluator[beads_query_schema-rows0-queries0]
    failed in 20260815T134437Z-8b4635ad13e8-2921048-full-run.json (head 8b4635ad13e8)
    excluded by 2 scoped run(s), first 20260810T222227Z-0ccd7f844731-800799.json (head 0ccd7f844731)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_query_profile_corpus_facade.py::test_rust_facade_matches_python_reference_evaluator[files_query_schema-rows1-queries1]
    failed in 20260815T134437Z-8b4635ad13e8-2921048-full-run.json (head 8b4635ad13e8)
    excluded by 2 scoped run(s), first 20260810T222227Z-0ccd7f844731-800799.json (head 0ccd7f844731)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_query_profile_corpus_facade.py::test_rust_facade_matches_python_reference_evaluator[patches_query_schema-rows2-queries2]
    failed in 20260815T134437Z-8b4635ad13e8-2921048-full-run.json (head 8b4635ad13e8)
    excluded by 2 scoped run(s), first 20260810T222227Z-0ccd7f844731-800799.json (head 0ccd7f844731)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_query_profile_corpus_facade.py::test_since_until_date_fields_use_range_comparison_through_rust
    failed in 20260815T134437Z-8b4635ad13e8-2921048-full-run.json (head 8b4635ad13e8)
    excluded by 2 scoped run(s), first 20260810T222227Z-0ccd7f844731-800799.json (head 0ccd7f844731)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_query_profile_corpus_facade.py::test_stale_index_validation_raises_on_row_count_mismatch
    failed in 20260815T134437Z-8b4635ad13e8-2921048-full-run.json (head 8b4635ad13e8)
    excluded by 2 scoped run(s), first 20260810T222227Z-0ccd7f844731-800799.json (head 0ccd7f844731)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_query_profile_corpus_facade.py::test_substring_vs_exact_field_match_mode_through_rust
    failed in 20260815T134437Z-8b4635ad13e8-2921048-full-run.json (head 8b4635ad13e8)
    excluded by 2 scoped run(s), first 20260810T222227Z-0ccd7f844731-800799.json (head 0ccd7f844731)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
...
flake-suppressed: 370 (10335 scoped run/failure matches)
