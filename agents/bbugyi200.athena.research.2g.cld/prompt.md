%id(cld, clan=research.2g)
%m:claude/opus@xhigh %q(w=0.25)
#gh:gh_sase-org__sase 
You are researcher cld in a 3-researcher swarm.
The other researchers, `research.2g.mus`, `research.2g.gem`, are independently investigating the same request and will write their own self-named reports ending in `__mus.md` and `__gem.md`. Your report will end in `__cld.md`.
...
good as-is? End your analysis with a recommended solution. #research(suffix=cld)