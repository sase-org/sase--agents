#gh:gh_sase-org__sase I'm running into an error when trying to upgrade codex. See the command output below. Can you help me diagnose the root cause of this issue and update codex like I've been trying to do?
```
