...
**Global name:** `bbugyi200.athena.sase-kp.6` · **State:** completed · **Source run:** `run-44d0eec521b86c239bf0598826ff8864`

**Owner:** `bbugyi200.athena` · **Project:** sase · **Hood:** sase-kp

## Summary

- Bead: [sase-kp.6](https://github.com/sase-org/sase--beads/blob/main/pages/sase-kp/sase-kp.6.md)
...
|---|---|---|---|
| sase | [`8340b45`](https://github.com/sase-org/sase/commit/8340b457af2d9b6f3f8348bdf8057ab41077c9ef) | feat(monitor): add sase monitor start\|stop\|list\|show CLI | 2026-08-13 10:36:37 UTC |
