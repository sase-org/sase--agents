...
**Global name:** `bbugyi200.athena.sase-pw.6` · **State:** completed · **Source run:** `run-ee299abafecc030735f4ec6f0a24731e`

**Owner:** `bbugyi200.athena` · **Project:** sase · **Hood:** sase-pw

## Summary

- Bead: [sase-pw.6](https://github.com/sase-org/sase--beads/blob/main/pages/sase-pw/sase-pw.6.md)
...
|---|---|---|---|
| sase | [`26c53b0`](https://github.com/sase-org/sase/commit/26c53b07e76a4b87ce06d10d1be6e34101f2add8) | feat(tui): seed panes and the + picker from the current project | 2026-08-18 19:53:21 UTC |
