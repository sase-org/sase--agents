...
example, if the user were to press `H`, I would expect the `02i` agent family to be
collapsed. But this doesn't work. The entire agent shell / agent family is just
immediately collapsed. Can you help me fix this?
