# Chat History - ace-run (sase-11l.10--mon-3)

- **TIMESTAMP:** 2026-09-18 14:45:05 EDT
- **MODEL:** grok/grok-4.6
- **AGENT:** sase-11l.10--mon-3

## Prompt

sase monitor start --command 'n=0\nwhile [ "$n" -lt 90 ]; do\n  load=$(cut -d. -f1 /proc/loadavg)\n  printf "precheck load=%s (%s/90)\\n" "$load" "$n"\n  if [ "$load" -le 10 ]; then\n    break\n  fi\n  n=$((n + 1))\n  sleep 60\ndone\njust check-full' --reason 'Wait for quieter host load, then re-run the required full landing gate for phase sase-11l.10 after recalibrating hard test-cost CPU budgets'

## Response

precheck load=9 (0/90)
...
✓ committed plans
✓ test cost
test cost budget advisories: /home/bryan/.sase/test-selection/gh_sase-org__sase/timings/cost/20260918T184300Z-1804482.json
wall-clock overages usually mean the host was busy, not that the suite got more expensive; the cpu/count figures alongside each entry are contention-stable, so compare them to tell the two apart.
- [advisory] total_file_wall_seconds: actual 5885.409 exceeds budget 4700.000 + 15% tolerance (5405.000) (cpu=3405.120s)
- [advisory] causes.ace_page_enter: actual 1122.903 exceeds budget 540.000 + 15% tolerance (621.000) (cpu=1123.769s, count=779)
- [advisory] causes.ace_settle_pilot: actual 498.102 exceeds budget 340.000 + 15% tolerance (391.000) (cpu=477.056s, count=8974)
- [advisory] causes.parser_create: actual 77.461 exceeds budget 52.000 + 15% tolerance (59.800) (cpu=77.085s, count=2037)
- [advisory] causes.pilot_pause_delay: actual 453.182 exceeds budget 230.000 + 15% tolerance (264.500) (cpu=417.484s, count=18337)
- [advisory] causes.textual_app_run_test_enter: actual 880.766 exceeds budget 470.000 + 15% tolerance (540.500) (cpu=882.624s, count=4015)
- [advisory] causes.yaml_load: actual 25.613 exceeds budget 20.000 + 15% tolerance (23.000) (cpu=25.534s, count=60898)
✗ flake baseline
.venv/bin/python tools/setup_required_plugins
[setup] Installing required plugin sase-github>=0.2.5.
[setup] Installing required plugin sase-research-artifacts>=0.2.0.
...
scoped runs slower than the full lane (444.0s): 153 of 2172
  ...
  20260918T180727Z-e0f1a8d43ad8-1432232.json: 777.6s at 4 workers, 415 file(s) selected, rules: context-baseline-stale, context-selection, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
  ...
  20260918T152627Z-abfa4c89d176-2671148.json: 627.0s at 4 workers, 740 file(s) selected, rules: context-baseline-stale, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
  ...
  20260918T163021Z-af8b7ec14009-4010839.json: 571.9s at 4 workers, 1002 file(s) selected, rules: context-baseline-stale, context-selection, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
...
middle gear: 380 run(s) leased a bounded width, 31 refused and escalated instead
  timed runs by width: 348 at 1 worker, 9 at 2 workers, 4 at 3 workers, 367 at 4 workers
  the durations above pool these widths; a wide run's wall clock is not a serial one's

coverage contexts:
  runs that consulted it: 759 of 2172 (1413 escalated before it mattered)
  runs with a baseline:  759 of 759
  runs without one:      0 (static closure alone)
  runs on a stale one:   759
  test files contributed: 23480 (cumulative)

false negatives: 1307 (3351 scoped run/failure matches)
  ...
  tests/ace/tui/artifacts_contract/test_no_ref_prefix_dispatch.py::test_behavioral_modules_do_not_dispatch_on_ref_prefix
    ...
    excluded by 13 scoped run(s), first 20260825T224023Z-678988da7343-1192385.json (head 678988da7343)
  ...
  tests/ace/tui/test_axe_selection_identity.py::test_off_tab_rebuild_does_not_mutate_current_idx
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/ace/tui/test_kill_and_edit_agent_name.py::test_kill_and_edit_family_root_keeps_clan_identity
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/test_launch_hold_guard_panel.py::test_hold_guard_cancel_leaves_the_prompt_bar_mounted
    failed in 20260918T150752Z-abfa4c89d176-2533614-full-run.json (head abfa4c89d176)
    excluded by 1 scoped run(s), first 20260828T195028Z-bcd6813d270a-3017944.json (head bcd6813d270a)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/test_launch_hold_guard_panel.py::test_hold_guard_confirms_a_broad_hold_and_launches
    failed in 20260918T150752Z-abfa4c89d176-2533614-full-run.json (head abfa4c89d176)
    excluded by 1 scoped run(s), first 20260828T195028Z-bcd6813d270a-3017944.json (head bcd6813d270a)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/ace/tui/test_procs_pane_filter.py::test_dismiss_restores_the_query_active_when_the_session_opened
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, context-selection, contract-set-always, no-baseline-depth-boost, serial-budget-exceeded
  tests/ace/tui/test_procs_pane_filter.py::test_m_cycles_monitor_filter_from_empty_and_hides_the_bar
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/test_procs_pane_filter.py::test_m_inside_open_editor_types_the_letter
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/test_procs_pane_filter.py::test_typing_narrows_rows_live_without_committing
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/test_procs_pane_header_counts.py::test_header_counts_move_with_scope_toggle
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/test_procs_pane_header_counts.py::test_header_excludes_finished_monitor_from_running_count
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/test_procs_pane_header_counts.py::test_header_splits_running_procs_and_running_monitors
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/test_procs_pane_header_counts.py::test_header_zero_lanes_render_dim_unfilled_chip
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/test_startup_loading_indicators.py::test_axe_info_panel_loading_renders_ellipsis
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/ace/tui/widgets/test_agent_display_clan.py::test_family_header_recolors_only_real_container_name
    failed in 20260822T120239Z-8c1acbfa5056-1246775-full-run.json (head 8c1acbfa5056)
    excluded by 1 scoped run(s), first 20260820T153115Z-43b79bf12b5b-2835222.json (head 43b79bf12b5b)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/ace/tui/widgets/test_history_word_completion_ranking.py::test_smart_mode_shared_extension_uses_typed_case
    ...
    matched across unrelated changes; suspect a flake before a miss
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/widgets/test_keybinding_footer_stopwatch.py::test_default_state_shows_stopwatch
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/widgets/test_keybinding_footer_stopwatch.py::test_stopwatch_tier_boundaries[1.0-rgb(155,89,182)-white-False]
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/widgets/test_keybinding_footer_stopwatch.py::test_stopwatch_tier_boundaries[12.9-rgb(220,38,38)-white-False]
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/widgets/test_keybinding_footer_stopwatch.py::test_stopwatch_tier_boundaries[13.0-rgb(255,40,40)-white-True]
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/widgets/test_keybinding_footer_stopwatch.py::test_stopwatch_tier_boundaries[2.9-rgb(155,89,182)-white-False]
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/widgets/test_keybinding_footer_stopwatch.py::test_stopwatch_tier_boundaries[3.0-rgb(250,204,21)-black-False]
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/widgets/test_keybinding_footer_stopwatch.py::test_stopwatch_tier_boundaries[4.9-rgb(250,204,21)-black-False]
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/widgets/test_keybinding_footer_stopwatch.py::test_stopwatch_tier_boundaries[5.0-rgb(249,115,22)-black-False]
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/widgets/test_keybinding_footer_stopwatch.py::test_stopwatch_tier_boundaries[7.9-rgb(249,115,22)-black-False]
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/widgets/test_keybinding_footer_stopwatch.py::test_stopwatch_tier_boundaries[8.0-rgb(220,38,38)-white-False]
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/ace/tui/widgets/test_navigation_widgets.py::test_tab_bar_label_order_is_agents_artifacts_axe
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/ace/tui/widgets/test_prompt_xprompt_highlight.py::test_xprompt_highlight_overlay_marks_spans_and_registers_styles
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/agent/test_launch_hold_preview.py::test_hold_confirmation_body_flags_future_with_host_scope
    failed in 20260918T150752Z-abfa4c89d176-2533614-full-run.json (head abfa4c89d176)
    excluded by 1 scoped run(s), first 20260828T195028Z-bcd6813d270a-3017944.json (head bcd6813d270a)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/agent/test_launch_hold_preview.py::test_hold_confirmation_body_flags_future_with_host_scope_unconditionally
    failed in 20260918T150752Z-abfa4c89d176-2533614-full-run.json (head abfa4c89d176)
    excluded by 1 scoped run(s), first 20260828T195028Z-bcd6813d270a-3017944.json (head bcd6813d270a)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/agent/test_launch_hold_preview.py::test_hold_confirmation_body_flags_pending_capture_above_threshold
    failed in 20260918T150752Z-abfa4c89d176-2533614-full-run.json (head abfa4c89d176)
    excluded by 1 scoped run(s), first 20260828T195028Z-bcd6813d270a-3017944.json (head bcd6813d270a)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/completion/test_build.py::test_suppressed_option_is_kept_and_flagged_hidden
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/completion/test_build.py::test_tui_tab_omits_legacy_choices
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/core/test_disk_footprint.py::test_managed_tmp_reap_step_reports_age_only_bytes
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/dispatch/test_machine_init.py::test_onboarding_assessment_offers_new_unreviewed_candidate
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 8 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 2
    matched across unrelated changes; suspect a flake before a miss
    rules across those runs: context-baseline-stale, context-selection, contract-set-always, contract-set-only, no-baseline-depth-boost, serial-budget-exceeded
  ...
  tests/main/test_init_memory_validation.py::test_init_memory_registry_runs_after_config
    ...
    excluded by 9 scoped run(s), first 20260825T155054Z-2fa772b93d3e-1599208.json (head 2fa772b93d3e)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/main/test_init_onboarding_parser.py::test_init_help_lists_existing_subcommands
    ...
    matched across unrelated changes; suspect a flake before a miss
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/main/test_init_onboarding_parser.py::test_registry_order_is_config_machine_memory_repo_skills
    failed in 20260918T101546Z-d3ee151fd97e-314472-full-run.json (head d3ee151fd97e)
  ...
  tests/main/test_init_onboarding_parser.py::test_registry_order_is_config_memory_repo_skills
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/main/test_init_onboarding_reporting.py::test_bare_init_check_skips_repo_outside_project
    failed in 20260918T101546Z-d3ee151fd97e-314472-full-run.json (head d3ee151fd97e)
    excluded by 1 scoped run(s), first 20260905T230802Z-302e6d643af4-2600707.json (head 302e6d643af4)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/main/test_init_skills_sources.py::test_shipped_skill_source_is_discoverable_for_all_skill_providers[sase_monitor-expected_phrases7]
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/main/test_launch_hold_confirm.py::test_confirm_hold_arm_declines_when_user_says_no
    failed in 20260918T150752Z-abfa4c89d176-2533614-full-run.json (head abfa4c89d176)
    excluded by 1 scoped run(s), first 20260828T195028Z-bcd6813d270a-3017944.json (head bcd6813d270a)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/main/test_launch_hold_confirm.py::test_confirm_hold_arm_prompts_for_a_broad_hold_on_a_tty
    failed in 20260918T150752Z-abfa4c89d176-2533614-full-run.json (head abfa4c89d176)
    excluded by 1 scoped run(s), first 20260828T195028Z-bcd6813d270a-3017944.json (head bcd6813d270a)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_agent_names_extract_templates.py::TestExtractDirectivesTemplates::test_generated_template_name_uses_planned_name_without_explicit_claim
    failed in 20260907T022252Z-09c93253dc76-14018-full-run.json (head 09c93253dc76)
    excluded by 6 scoped run(s), first 20260821T194632Z-28009002d5da-3576112.json (head 28009002d5da)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_alias_history_modal.py::test_modal_navigation_skips_group_headers_and_spacers
    failed in 20260908T182214Z-3f9c7b451655-3098521-full-run.json (head 3f9c7b451655)
    excluded by 9 scoped run(s), first 20260821T194632Z-28009002d5da-3576112.json (head 28009002d5da)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_alias_history_modal.py::test_modal_single_alias_renders_runs_without_group_header
    failed in 20260908T183548Z-952ef34f5a8b-3321339-full-run.json (head 952ef34f5a8b)
    excluded by 6 scoped run(s), first 20260820T174320Z-4c304ad1fb78-685866.json (head 4c304ad1fb78)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_git_setup_adopt_runner_workspace.py::test_pre_allocated_env_still_wins_over_parent_claim
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_hold_directive.py::test_hold_is_unconditional_and_bare_hold_requires_selector
    failed in 20260918T150752Z-abfa4c89d176-2533614-full-run.json (head abfa4c89d176)
    excluded by 1 scoped run(s), first 20260828T195028Z-bcd6813d270a-3017944.json (head bcd6813d270a)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_keybinding_footer_status.py
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_keybinding_footer_status.py::test_keybinding_footer_startup_indicator_is_labeled
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_keybinding_footer_status.py::test_keybinding_footer_status_indicator_restarting
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_keybinding_footer_status.py::test_keybinding_footer_status_indicator_running
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_keybinding_footer_status.py::test_keybinding_footer_status_indicator_starting
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_keybinding_footer_status.py::test_keybinding_footer_status_indicator_stopped
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_keybinding_footer_status.py::test_keybinding_footer_status_indicator_stopping
    failed in 20260918T103543Z-c331faace369-729810-full-run.json (head c331faace369)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_launch_pane.py
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_launch_preview.py::test_launch_preview_renders_holds_section_for_a_held_slot
    failed in 20260918T150752Z-abfa4c89d176-2533614-full-run.json (head abfa4c89d176)
    excluded by 1 scoped run(s), first 20260828T195028Z-bcd6813d270a-3017944.json (head bcd6813d270a)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_launch_preview.py::test_launch_preview_warns_on_future_scope_host_hold
    failed in 20260918T150752Z-abfa4c89d176-2533614-full-run.json (head abfa4c89d176)
    excluded by 1 scoped run(s), first 20260828T195028Z-bcd6813d270a-3017944.json (head bcd6813d270a)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_launch_request_typed_plan.py::test_typed_plan_preview_renders_holds_section_for_a_held_unit
    failed in 20260918T150752Z-abfa4c89d176-2533614-full-run.json (head abfa4c89d176)
    excluded by 1 scoped run(s), first 20260828T195028Z-bcd6813d270a-3017944.json (head bcd6813d270a)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_linked_repo_workspaces.py::test_sidecar_materialization_uses_remote_not_divergent_primary
    failed in 20260918T160052Z-af8b7ec14009-3458946-full-run.json (head af8b7ec14009)
    excluded by 8 scoped run(s), first 20260914T192833Z-ccd32537f54e-3417275.json (head ccd32537f54e)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_llm_provider_invoke.py::test_invoke_agent_unknown_execution_provider_is_actionable
    failed in 20260906T210053Z-a45669b26fd3-2358100-full-run.json (head a45669b26fd3)
    excluded by 1 scoped run(s), first 20260828T195028Z-bcd6813d270a-3017944.json (head bcd6813d270a)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_models_panel_navigation.py::test_panel_navigation_skips_headers_and_empty_hint_with_wrap
    failed in 20260828T232905Z-0235ff059ad3-2057698-full-run.json (head 0235ff059ad3)
    excluded by 1 scoped run(s), first 20260825T172951Z-b85cdffd3de6-3592604.json (head b85cdffd3de6)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  ...
  tests/test_strip_pr_tags.py::test_tags_with_trailing_blank_lines
    ...
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
  tests/test_sudo_acceptance.py::test_sudo_local_flow_never_persists_canary_credentials
    failed in 20260918T131613Z-7359446b94a9-336163-full-run.json (head 7359446b94a9)
    excluded by 1 scoped run(s), first 20260918T063944Z-99eb1acc0ed9-1178603.json (head 99eb1acc0ed9)
    distinct change sets: 1
    rules across those runs: context-baseline-stale, contract-set-always, contract-set-only, no-baseline-depth-boost
...
flake-suppressed: 1246 (12934 scoped run/failure matches)
  ...
  tests/test_hold_directive.py::test_hold_adapter_reports_errors_and_expands_selectors
  tests/test_hold_directive.py::test_hold_extracts_repeatable_fields_and_formats_canonical_directive
  tests/test_hold_directive.py::test_hold_rejects_repeat_in_python_parser
  tests/test_hold_directive.py::test_typed_launch_threads_hold_and_rebuilds_dispatch_prompt
  ...
  tests/test_xprompt_directive_completion_parity.py::test_ace_and_lsp_hold_hood_rows_match_when_enabled
  tests/test_xprompt_directive_completion_parity.py::test_ace_and_lsp_hold_scope_rows_match_when_enabled
  tests/test_xprompt_directive_completion_parity.py::test_ace_and_lsp_hold_target_rows_match_when_enabled
  ...
  tests/test_xprompt_directive_completion_parity.py::test_ace_and_lsp_include_hold_directive_when_enabled
...
flake baseline gate: 3 reproducible flake(s) exceed tests/reproducible_flake_baseline.txt (records after 2026-08-15T17:22:27Z, at most 5 failures per run):
  tests/completion/test_snapshot.py::test_checked_in_snapshot_has_no_drift
  tests/completion/test_snapshot.py::test_current_structural_view_matches_checked_in_snapshot
  tests/llm_provider/test_usage_transport.py::test_jsonline_descendant_cleanup
Additions require a filed bead; fix or file the node before landing.
flake baseline gate: 14 recorded node ID(s) no longer collectable (renamed or deleted test); excluded as stale rather than gated as a live flake:
  tests/ace/tui/widgets/test_prompt_panel_section_navigation_targets.py::test_active_section_reconciles_across_same_document_rerender
  tests/ace/tui/widgets/test_prompt_panel_section_navigation_targets.py::test_cheap_paint_preserves_section_until_enriched_layout_returns
...
flake baseline gate: 130 failure(s) excluded from flake evidence as attributable dirty-tree source-audit breakage (recorded tree_dirty=True and a changed file inside the failing audit's own scanned source root):
  ...
  tests/ace/tui/artifacts_contract/test_no_ref_prefix_dispatch.py::test_behavioral_modules_do_not_dispatch_on_ref_prefix (20260918T105512Z-eaa1cbf4de92-1308880-full-run.json)
  ...
  tests/completion/test_snapshot.py::test_checked_in_snapshot_has_no_drift (20260918T090619Z-d76b742cffc3-3196852-full-run.json)
  tests/completion/test_snapshot.py::test_checked_in_snapshot_has_no_drift (20260918T091422Z-d76b742cffc3-3361535-full-run.json)
  tests/completion/test_snapshot.py::test_checked_in_snapshot_has_no_drift (20260918T103951Z-9ecf40c5d60a-864183-full-run.json)
  tests/completion/test_snapshot.py::test_checked_in_snapshot_has_no_drift (20260918T165050Z-c8c842fb3e8f-384465-full-run.json)
  ...
  tests/completion/test_snapshot.py::test_current_structural_view_matches_checked_in_snapshot (20260918T090619Z-d76b742cffc3-3196852-full-run.json)
  tests/completion/test_snapshot.py::test_current_structural_view_matches_checked_in_snapshot (20260918T091422Z-d76b742cffc3-3361535-full-run.json)
  tests/completion/test_snapshot.py::test_current_structural_view_matches_checked_in_snapshot (20260918T103951Z-9ecf40c5d60a-864183-full-run.json)
  tests/completion/test_snapshot.py::test_current_structural_view_matches_checked_in_snapshot (20260918T165050Z-c8c842fb3e8f-384465-full-run.json)
...
flake baseline gate: 233 failure(s) retired by a # fixed-at: entry in tests/reproducible_flake_baseline.txt:
  ...
  tests/main/test_init_skills_sources.py::test_shipped_skill_source_is_discoverable_for_all_skill_providers[sase_questions-expected_phrases11] (20260827T134634Z-30f384324343-3050372-full-run.json)
  tests/main/test_init_skills_sources.py::test_shipped_skill_source_is_discoverable_for_all_skill_providers[sase_questions-expected_phrases11] (20260916T161906Z-9759e5afe8c0-3788192-full-run.json)
  tests/main/test_init_skills_sources.py::test_shipped_skill_source_is_discoverable_for_all_skill_providers[sase_questions-expected_phrases11] (20260916T170223Z-491daa988a20-594840-full-run.json)
  tests/main/test_init_skills_sources.py::test_shipped_skill_source_is_discoverable_for_all_skill_providers[sase_questions-expected_phrases11] (20260916T172318Z-44f4c441706f-1132967-full-run.json)
  tests/main/test_init_skills_sources.py::test_shipped_skill_source_is_discoverable_for_all_skill_providers[sase_questions-expected_phrases11] (20260916T175123Z-7636fe03b8c3-1957671-full-run.json)
  tests/main/test_init_skills_sources.py::test_shipped_skill_source_is_discoverable_for_all_skill_providers[sase_questions-expected_phrases11] (20260916T180608Z-7636fe03b8c3-2264033-full-run.json)
  tests/main/test_init_skills_sources.py::test_shipped_skill_source_is_discoverable_for_all_skill_providers[sase_questions-expected_phrases11] (20260916T182711Z-7636fe03b8c3-2829601-full-run.json)
  ...
  tests/shells/test_shells_substrate.py::test_shell_done_marker_writers_stamp_finished_at_through_shared_helper (20260914T074415Z-c12285ffd4bb-3653826-full-run.json)
  tests/shells/test_shells_substrate.py::test_shell_done_marker_writers_stamp_finished_at_through_shared_helper (20260914T090109Z-e87a5b459528-38717-full-run.json)
  tests/shells/test_shells_substrate.py::test_shell_done_marker_writers_stamp_finished_at_through_shared_helper (20260914T094619Z-fc9a8317c5cf-418576-full-run.json)
  tests/shells/test_shells_substrate.py::test_shell_done_marker_writers_stamp_finished_at_through_shared_helper (20260914T100943Z-70712f0c806f-655034-full-run.json)
  tests/shells/test_shells_substrate.py::test_shell_done_marker_writers_stamp_finished_at_through_shared_helper (20260914T114623Z-f56dae6dd18e-1784395-full-run.json)
  tests/shells/test_shells_substrate.py::test_shell_done_marker_writers_stamp_finished_at_through_shared_helper (20260914T121920Z-23d7f54726f1-2432189-full-run.json)
  ...
  tests/test_agent_artifact_dismissed_save_audit.py::test_dismissed_agent_save_sites_are_reviewed (20260914T090109Z-e87a5b459528-38717-full-run.json)
  tests/test_agent_artifact_dismissed_save_audit.py::test_dismissed_agent_save_sites_are_reviewed (20260914T094619Z-fc9a8317c5cf-418576-full-run.json)
  tests/test_agent_artifact_dismissed_save_audit.py::test_dismissed_agent_save_sites_are_reviewed (20260914T100943Z-70712f0c806f-655034-full-run.json)
  tests/test_agent_artifact_dismissed_save_audit.py::test_dismissed_agent_save_sites_are_reviewed (20260914T114623Z-f56dae6dd18e-1784395-full-run.json)
  tests/test_agent_artifact_dismissed_save_audit.py::test_dismissed_agent_save_sites_are_reviewed (20260914T121920Z-23d7f54726f1-2432189-full-run.json)
  tests/test_agent_artifact_dismissed_save_audit.py::test_reviewed_dismissed_agent_save_sites_sync_projection (20260914T090109Z-e87a5b459528-38717-full-run.json)
  tests/test_agent_artifact_dismissed_save_audit.py::test_reviewed_dismissed_agent_save_sites_sync_projection (20260914T094619Z-fc9a8317c5cf-418576-full-run.json)
  tests/test_agent_artifact_dismissed_save_audit.py::test_reviewed_dismissed_agent_save_sites_sync_projection (20260914T100943Z-70712f0c806f-655034-full-run.json)
  tests/test_agent_artifact_dismissed_save_audit.py::test_reviewed_dismissed_agent_save_sites_sync_projection (20260914T114623Z-f56dae6dd18e-1784395-full-run.json)
  tests/test_agent_artifact_dismissed_save_audit.py::test_reviewed_dismissed_agent_save_sites_sync_projection (20260914T121920Z-23d7f54726f1-2432189-full-run.json)
  tests/test_agent_hold_service.py::test_rebind_agent_hold_round_trips_and_keeps_created_at (20260917T134445Z-88175f34fc8b-1032448-full-run.json)
  tests/test_agent_hold_service.py::test_rebind_agent_hold_round_trips_and_keeps_created_at (20260917T143948Z-96288aea4cfe-2559202-full-run.json)
  tests/test_agent_hold_service.py::test_rebind_agent_hold_round_trips_and_keeps_created_at (20260917T201047Z-ff088437985f-1358975-full-run.json)
  tests/test_agent_hold_service.py::test_rebind_agent_hold_round_trips_and_keeps_created_at (20260917T203800Z-ff088437985f-2028300-full-run.json)
  tests/test_agent_hold_service.py::test_rebind_agent_hold_round_trips_and_keeps_created_at (20260918T034624Z-26a43d29f47f-2696642-full-run.json)
  ...
  tests/test_gate_cli_show.py::test_show_reports_an_accepted_failed_gate (20260918T004418Z-1d14218a3c29-3360603-full-run.json)
  tests/test_gate_cli_show.py::test_show_reports_an_accepted_failed_gate (20260918T010003Z-1d14218a3c29-3689707-full-run.json)
  tests/test_gate_cli_show.py::test_show_reports_an_accepted_failed_gate (20260918T010918Z-677ed7d8e496-3896041-full-run.json)
  tests/test_gate_cli_show.py::test_show_reports_an_accepted_failed_gate (20260918T011959Z-1d14218a3c29-4174089-full-run.json)
  tests/test_gate_cli_show.py::test_show_reports_an_accepted_failed_gate (20260918T012838Z-c199dcb6ca5b-135907-full-run.json)
  tests/test_gate_cli_show.py::test_show_reports_an_accepted_failed_gate (20260918T014935Z-c199dcb6ca5b-653958-full-run.json)
  tests/test_gate_cli_show.py::test_show_reports_an_accepted_failed_gate (20260918T015330Z-c199dcb6ca5b-748008-full-run.json)
  tests/test_gate_decision_acceptance.py::test_cancel_is_permitted_after_current_failure (20260918T004418Z-1d14218a3c29-3360603-full-run.json)
  tests/test_gate_decision_acceptance.py::test_cancel_is_permitted_after_current_failure (20260918T010003Z-1d14218a3c29-3689707-full-run.json)
  tests/test_gate_decision_acceptance.py::test_cancel_is_permitted_after_current_failure (20260918T010918Z-677ed7d8e496-3896041-full-run.json)
  tests/test_gate_decision_acceptance.py::test_cancel_is_permitted_after_current_failure (20260918T011959Z-1d14218a3c29-4174089-full-run.json)
  tests/test_gate_decision_acceptance.py::test_cancel_is_permitted_after_current_failure (20260918T012838Z-c199dcb6ca5b-135907-full-run.json)
  tests/test_gate_decision_acceptance.py::test_cancel_is_permitted_after_current_failure (20260918T014935Z-c199dcb6ca5b-653958-full-run.json)
  tests/test_gate_decision_acceptance.py::test_cancel_is_permitted_after_current_failure (20260918T015330Z-c199dcb6ca5b-748008-full-run.json)
  tests/test_gate_decision_acceptance.py::test_conflicting_selection_supersedes_after_current_failure (20260918T004418Z-1d14218a3c29-3360603-full-run.json)
  tests/test_gate_decision_acceptance.py::test_conflicting_selection_supersedes_after_current_failure (20260918T010003Z-1d14218a3c29-3689707-full-run.json)
  tests/test_gate_decision_acceptance.py::test_conflicting_selection_supersedes_after_current_failure (20260918T010918Z-677ed7d8e496-3896041-full-run.json)
  tests/test_gate_decision_acceptance.py::test_conflicting_selection_supersedes_after_current_failure (20260918T011959Z-1d14218a3c29-4174089-full-run.json)
  tests/test_gate_decision_acceptance.py::test_conflicting_selection_supersedes_after_current_failure (20260918T012838Z-c199dcb6ca5b-135907-full-run.json)
  tests/test_gate_decision_acceptance.py::test_conflicting_selection_supersedes_after_current_failure (20260918T014935Z-c199dcb6ca5b-653958-full-run.json)
  tests/test_gate_decision_acceptance.py::test_conflicting_selection_supersedes_after_current_failure (20260918T015330Z-c199dcb6ca5b-748008-full-run.json)
  tests/test_justfile_lint.py::test_rust_dev_install_disables_cargo_incremental_cache (20260914T130018Z-8bd8fb891dd9-3402946-full-run.json)
...
error: recipe `selection-health` failed on line 637 with exit code 1
