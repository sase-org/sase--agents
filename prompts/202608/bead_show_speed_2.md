...
- **AGENTS:**
  - [bbugyi200.athena.sase-en.2](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-en.2/README.md)
...
%id(2, clan=sase-en, bead=sase-en.2) %model:@medium_phase_worker %auto
[#bd/work_phase_bead:sase-en.2](https://github.com/sase-org/sase/blob/e5208ec977cbe6974ccfa32526f4197b697caf1e/src/sase/default_config.yml#L1022)
...
```markdown
Can you complete the work for bead sase-en.2? The bead is already reserved for you and assigned to your agent name: it
...
the work, and close the bead with `sase bead close sase-en.2 --note "<what you verified>"`. Closing an assigned phase
...
`sase bead note sase-en.2 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the epic's land agent triages these into
task beads.
```
