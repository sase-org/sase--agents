...
- **AGENTS:**
  - [bbugyi200.athena.sase-f1.1](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-f1.1/README.md)
...
%id(sase-f1.1, bead=sase-f1.1) %clan(sase-f1, tribe=epic, summary_script=sase_clan_summary_epic)
%model:@medium_phase_worker %auto
[#bd/work_phase_bead:sase-f1.1](https://github.com/sase-org/sase/blob/5c76b3d4b72c2626b1fd98267a1d00cb48981279/src/sase/default_config.yml#L1021)
...
```markdown
Can you complete the work for bead sase-f1.1? The bead is already reserved for you and assigned to your agent name: it
...
the work, and close the bead with `sase bead close sase-f1.1 --note "<what you verified>"`. Closing an assigned phase
...
`sase bead note sase-f1.1 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the epic's land agent triages these into
task beads.
```
