- **PLAN:**
  [202608/shells_substrate.md](https://github.com/sase-org/sase--plans/blob/main/202608/shells_substrate.md)
- **AGENTS:**
  - [bbugyi200.athena.sase-ud.2--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-ud.2.md)

Can you complete the work for bead sase-ud.2? The bead is already reserved for you and
...
`sase bead epic-symbols sase-ud.2`. If this phase still has `--epic-symbol` entries,
...
`sase bead note sase-ud.2 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the epic's
