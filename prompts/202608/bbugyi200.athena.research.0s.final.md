- **AGENTS:**
  - [bbugyi200.athena.research.0s.final](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.0s.final/README.md)

%id(final, clan=research.0s) %wait(priority=20) %m:@research_lead %wait:research.0s.cdx
%wait:research.0s.cld #gh:gh_sase-org__sase You are the lead researcher: two
