- **PLAN:**
  [202608/patch_tui_config_surface.md](https://github.com/sase-org/sase--plans/blob/main/202608/patch_tui_config_surface.md)
- **AGENTS:**
  - [bbugyi200.athena.sase-hn.4--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-hn.4.md)

Can you complete the work for bead sase-hn.4? The bead is already reserved for you and
...
`sase bead close sase-hn.4 --note "<what you verified>"`. Closing an assigned phase bead
...
via `sase bead note sase-hn.4 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the
