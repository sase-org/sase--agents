- **PLAN:**
  [202608/successor_publication.md](https://github.com/sase-org/sase--plans/blob/main/202608/successor_publication.md)
- **AGENTS:**
  - [bbugyi200.athena.sase-rm.4--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-rm.4.md)

Can you complete the work for bead sase-rm.4? The bead is already reserved for you and
...
`sase bead epic-symbols sase-rm.4`. If this phase still has `--epic-symbol` entries,
...
`sase bead note sase-rm.4 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the epic's
