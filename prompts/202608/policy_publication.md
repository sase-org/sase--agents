- **PLAN:**
  [202608/policy_publication.md](https://github.com/sase-org/sase--plans/blob/main/202608/policy_publication.md)
- **AGENTS:**
  - [bbugyi200.athena.sase-rm.3--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-rm.3.md)

Can you complete the work for bead sase-rm.3? The bead is already reserved for you and
...
`sase bead epic-symbols sase-rm.3`. If this phase still has `--epic-symbol` entries,
...
`sase bead note sase-rm.3 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the epic's
