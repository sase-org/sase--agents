...
- **AGENTS:**
  - [bbugyi200.athena.sase-ej.5](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-ej.5/README.md)
...
%id(5, clan=sase-ej, bead=sase-ej.5) %model:@small_phase_worker %auto %w:sase-ej.4 %w(bead=sase-ej.4)
[#bd/work_phase_bead:sase-ej.5](https://github.com/sase-org/sase/blob/1116bccb0a4390e748a4042b9e92bbcb50d991a2/src/sase/default_config.yml#L1020)
...
```markdown
Can you complete the work for bead sase-ej.5? The bead is already reserved for you and assigned to your agent name: it
...
the work, and close the bead with `sase bead close sase-ej.5 --note "<what you verified>"`. Closing an assigned phase
...
`sase bead note sase-ej.5 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the epic's land agent triages these into
task beads.
```
