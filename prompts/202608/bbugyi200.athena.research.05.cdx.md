- **AGENTS:**
  - [bbugyi200.athena.research.05.cdx](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.05.cdx/README.md)

%clan(research.05, tribe=research, summary=[[[bold]RESEARCH PROMPT:[/bold] I want to
start creating a corresponding bead for every external bug (e.g. GitHub issue--but this
should use our plugin system I think) created for sase projects that are enabled on the
given machine (I'm assuming we will use one or more chops for this, but I am open to
suggestions).
...
%wait(priority=20) %model:@research_a #gh:gh_sase-org__sase I want to start creating a
corresponding bead for every external bug (e.g. GitHub issue--but this should use our
plugin system I think) created for sase projects that are enabled on the given machine
(I'm assuming we will use one or more chops for this, but I am open to suggestions).
