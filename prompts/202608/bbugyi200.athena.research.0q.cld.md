- **AGENTS:**
  - [bbugyi200.athena.research.0q.cld](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.0q.cld/README.md)

%id(cld, clan=research.0q) %wait(priority=20) %m:@research_b #gh:gh_sase-org__sase I
want to make sase beats more powerful by making them configurable via sase plugin hooks.
