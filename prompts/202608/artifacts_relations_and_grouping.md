...
- **AGENTS:**
  - [bbugyi200.athena.sase-m6.7--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-m6.7.md)

Can you complete the work for bead sase-m6.7? The bead is already reserved for you and
...
`sase bead close sase-m6.7 --note "<what you verified>"`. Closing an assigned phase bead
...
`sase bead note sase-m6.7 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the epic's
