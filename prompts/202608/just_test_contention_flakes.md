- **PLAN:**
  [202608/just_test_contention_flakes.md](https://github.com/sase-org/sase--plans/blob/main/202608/just_test_contention_flakes.md)
- **AGENTS:**
  - [bbugyi200.athena.rw--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.rw.md#member-plan)

It looks like the `just test` command is failing (see the output below). Can you help me diagnose the root cause of this
issue and fix it? Think this through thoroughly and create a plan using your `/sase_plan` skill. Choose and author the
