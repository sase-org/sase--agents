- **AGENTS:**
  - [bbugyi200.athena.research.0w.cdx](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.0w.cdx/README.md)

%clan(research.0w, tribe=research, summary=[[[bold]RESEARCH PROMPT:[/bold] I want to add
support for stand-alone proc shells (i.e. shells that don't belong to an agent family)
to sase.
...
this? End your analysis with a recommended solution.]]) %id:research.0w.cdx
%model:@research_a #gh:gh_sase-org__sase I want to add support for stand-alone proc
shells (i.e. shells that don't belong to an agent family) to sase.
...
#research(report_target=research.0w.cdx.md)
