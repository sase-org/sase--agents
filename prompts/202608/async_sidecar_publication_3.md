...
- **AGENTS:**
  - [bbugyi200.athena.sase-ej.4](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-ej.4/README.md)
...
%id(4, clan=sase-ej, bead=sase-ej.4) %model:@medium_phase_worker %auto %w:sase-ej.2,sase-ej.3 %w(bead=sase-ej.2)
%w(bead=sase-ej.3)
[#bd/work_phase_bead:sase-ej.4](https://github.com/sase-org/sase/blob/3ac2b097beac842dc02df1edf88704ff87cd351d/src/sase/default_config.yml#L1002)
...
```markdown
Can you complete the work for bead sase-ej.4? The bead is already reserved for you and assigned to your agent name: it
...
the work, and close the bead with `sase bead close sase-ej.4 --note "<what you verified>"`. Closing an assigned phase
...
`sase bead note sase-ej.4 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the epic's land agent triages these into
task beads.
```
