- **AGENTS:**
  - [bbugyi200.athena.research.0j.final](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.0j.final/README.md)

%id(final, clan=research.0j) %wait(priority=20) %m:@research_lead %wait:research.0j.cdx
%wait:research.0j.cld #gh:gh_sase-org__sase You are the lead researcher: two
...
I want to unify the different Artifacts tabs with the goal of using an API / contract of
