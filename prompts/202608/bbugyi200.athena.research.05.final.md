- **AGENTS:**
  - [bbugyi200.athena.research.05.final](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.05.final/README.md)

%id(final, clan=research.05) %wait(priority=20) %m:@research_lead %wait:research.05.cdx
%wait:research.05.cld #gh:gh_sase-org__sase You are the lead researcher: two
...
I want to start creating a corresponding bead for every external bug (e.g. GitHub
issue--but this should use our plugin system I think) created for sase projects that are
enabled on the given machine (I'm assuming we will use one or more chops for this, but I
