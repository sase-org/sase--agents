- **AGENTS:**
  - [bbugyi200.athena.research.0y.cld](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.0y.cld/README.md)

%id(cld, clan=research.0y) %m:@research_b #gh:gh_sase-org__sase I want to migrate the
sase/memory/task_types.md memory file to a finalizer that is only active for sase
managed projects.
...
#research(report_target=research.0y.cld.md)
