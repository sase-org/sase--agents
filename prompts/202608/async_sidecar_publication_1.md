...
- **AGENTS:**
  - [bbugyi200.athena.sase-ej.2](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-ej.2/README.md)
...
%id(2, clan=sase-ej, bead=sase-ej.2) %model:@medium_phase_worker %auto
[#bd/work_phase_bead:sase-ej.2](https://github.com/sase-org/sase/blob/6e397794552c9e7e8e2feb593cb57f7382fd6b37/src/sase/default_config.yml#L1002)
...
```markdown
Can you complete the work for bead sase-ej.2? The bead is already reserved for you and assigned to your agent name: it
...
the work, and close the bead with `sase bead close sase-ej.2 --note "<what you verified>"`. Closing an assigned phase
...
`sase bead note sase-ej.2 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the epic's land agent triages these into
task beads.
```
