...
- **AGENTS:**
  - [bbugyi200.athena.050--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.050.md)

Can you help me add a new `sase glossary` command?
