...
- **AGENTS:**
  - [bbugyi200.athena.sase-ek.1](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-ek.1/README.md)
...
%id(sase-ek.1, bead=sase-ek.1) %clan(sase-ek, tribe=epic, summary_script=sase_clan_summary_epic)
%model:@small_phase_worker %auto
[#bd/work_phase_bead:sase-ek.1](https://github.com/sase-org/sase/blob/77ef3953e5c67c8be6247c4de1e2e62c474243a3/src/sase/default_config.yml#L1002)
...
```markdown
Can you complete the work for bead sase-ek.1? The bead is already reserved for you and assigned to your agent name: it
...
the work, and close the bead with `sase bead close sase-ek.1 --note "<what you verified>"`. Closing an assigned phase
...
`sase bead note sase-ek.1 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the epic's land agent triages these into
task beads.
```
