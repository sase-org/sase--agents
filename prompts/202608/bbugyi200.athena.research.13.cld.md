- **AGENTS:**
  - [bbugyi200.athena.research.13.cld](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.13.cld/README.md)

%id(cld, clan=research.13) %m:@research_b #gh:gh_sase-org__sase Sase seems to have
support for three different installation modes for plug-ins:
...
recommended solution. #research(report_target=research.13.cld.md)
