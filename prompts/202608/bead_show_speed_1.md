...
- **AGENTS:**
  - [bbugyi200.athena.sase-en.3](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-en.3/README.md)
...
%id(3, clan=sase-en, bead=sase-en.3) %model:@medium_phase_worker %auto
[#bd/work_phase_bead:sase-en.3](https://github.com/sase-org/sase/blob/7a66461b98890f66413bfbc67bc7a6d90b2c736f/src/sase/default_config.yml#L1022)
...
```markdown
Can you complete the work for bead sase-en.3? The bead is already reserved for you and assigned to your agent name: it
...
the work, and close the bead with `sase bead close sase-en.3 --note "<what you verified>"`. Closing an assigned phase
...
`sase bead note sase-en.3 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the epic's land agent triages these into
task beads.
```
