- **PLAN:**
  [202608/gate_shells.md](https://github.com/sase-org/sase--plans/blob/main/202608/gate_shells.md)
- **AGENTS:**
  - [bbugyi200.athena.0eg--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.0eg.md)

I want to give sase gates representation as named family shells ("gate shells"--which
should be added as a glossary term / memory strand for this project) that are added to
the agent family that created them (gates should create an agent family if the gate was
created by an agent shell that was previously not associated with an agent family). Can
