- **AGENTS:**
  - [bbugyi200.athena.research.y.final](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.y.final/README.md)
...
This project's test suite is getting to be very large and very slow, especially when parallel agents are run. Can you do
some research with the goal of helping me mitigate this problem somehow? Don't be afraid to explore/recommend large
architectural changes if that's genuinely the right approach, like splitting up the repo for example. End your analysis
...
1. Read both transcripts to learn which report file each researcher wrote (`research.y.cdx` -> `__a`, `research.y.cld`
