...
#gh:gh_sase-org__sase %id(4, clan=sase-en, bead=sase-en.4) %model:@small_phase_worker %auto
%w:sase-en.1,sase-en.2,sase-en.3 %w(bead=sase-en.1) %w(bead=sase-en.2) %w(bead=sase-en.3) #bd/work_phase_bead:sase-en.4
