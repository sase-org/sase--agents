- **AGENTS:**
  - [bbugyi200.athena.research.0k.cld](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.0k.cld/README.md)

%id(cld, clan=research.0k) %wait(priority=20) %m:@research_b #gh:gh_sase-org__sase I
want to eliminate procs that run inside the ACE TUI process, make every proc
