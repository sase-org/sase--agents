- **AGENTS:**
  - [bbugyi200.athena.research.05.cld](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.05.cld/README.md)

%id(cld, clan=research.05) %wait(priority=20) %m:@research_b #gh:gh_sase-org__sase I
want to start creating a corresponding bead for every external bug (e.g. GitHub
