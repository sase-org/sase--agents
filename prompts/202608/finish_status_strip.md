- **PLAN:**
  [202608/finish_status_strip.md](https://github.com/sase-org/sase--plans/blob/main/202608/finish_status_strip.md)
- **AGENTS:**
  - [bbugyi200.athena.sase-ud.13.1.3.1.land--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-ud.13.1.3.1.land.md)

You are the land agent for epic bead sase-ud.13.1.3.1: verify the epic is truly
complete, integrate it with changes that landed since it started, then close it out.

1. Verify. Run `sase bead show sase-ud.13.1.3.1` (children, linked plan file), review
...
2. Integrate. Changes committed since this epic started could not integrate with this
   ...
   commit mentioning sase-ud.13.1.3.1, excluding the epic's own commits; in a PR
...
3. Land. Unresolved issues caused by this epic remain epic work: plan and finish them
   ...
   close note. Before closing, run `sase bead epic-symbols sase-ud.13.1.3.1`. Every
   ...
   the epic with
   `sase bead close sase-ud.13.1.3.1 --note "<what you verified in steps 1-2>"`. After
...
`sase bead show sase-ud.13.1.3.1`. If there is no parent bead, finish normally. If the
