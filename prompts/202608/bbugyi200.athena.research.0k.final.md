- **AGENTS:**
  - [bbugyi200.athena.research.0k.final](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.0k.final/README.md)

%id(final, clan=research.0k) %wait(priority=20) %m:@research_lead %wait:research.0k.cdx
%wait:research.0k.cld #gh:gh_sase-org__sase You are the lead researcher: two
...
I want to eliminate procs that run inside the ACE TUI process, make every proc
supervisor-owned and detached, and remove the `-d|--detached` option from the
