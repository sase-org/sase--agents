- **PLAN:**
  [202608/link_follow_grammar.md](https://github.com/sase-org/sase--plans/blob/main/202608/link_follow_grammar.md)
- **AGENTS:**
  - [bbugyi200.athena.sase-ug.7--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-ug.7.md)

Can you complete the work for bead sase-ug.7? The bead is already reserved for you and
...
`sase bead epic-symbols sase-ug.7`. If this phase still has `--epic-symbol` entries,
...
`sase bead note sase-ug.7 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the epic's
