- **PLAN:**
  [202608/scope_ci_watch_per_repository.md](https://github.com/sase-org/sase--plans/blob/main/202608/scope_ci_watch_per_repository.md)
- **AGENTS:**
  - [bbugyi200.athena.sase-um.9.1--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-um.9.1.md)

Can you complete the work for bead sase-um.9.1? The bead is already reserved for you and
...
`sase bead epic-symbols sase-um.9.1`. If this phase still has `--epic-symbol` entries,
...
`sase bead note sase-um.9.1 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the
