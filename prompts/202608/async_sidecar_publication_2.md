...
- **AGENTS:**
  - [bbugyi200.athena.sase-ej.3](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.sase-ej.3/README.md)
...
%id(3, clan=sase-ej, bead=sase-ej.3) %model:@medium_phase_worker %auto %w:sase-ej.2 %w(bead=sase-ej.2)
[#bd/work_phase_bead:sase-ej.3](https://github.com/sase-org/sase/blob/0d6ed1a194b2cdb8c398399e82fcbcc903ee51f8/src/sase/default_config.yml#L1002)
...
```markdown
Can you complete the work for bead sase-ej.3? The bead is already reserved for you and assigned to your agent name: it
...
the work, and close the bead with `sase bead close sase-ej.3 --note "<what you verified>"`. Closing an assigned phase
...
`sase bead note sase-ej.3 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the epic's land agent triages these into
task beads.
```
