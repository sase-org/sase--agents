- **PLAN:** [202607/xprompt_swarms.md](https://github.com/sase-org/sase--plans/blob/main/202607/xprompt_swarms.md)

 sase currently has the concept of multi-agent xprompts that use three dashes to separate prompts that are used to launch different agents. Can you help me do an audit of this codebase, the sase-core repo and all of sase's plugin repos, for any instance of this name being used to describe this concept being used and update the text appropriately to use the name "xprompt swarms" instead, which is the new term I would like to use for these xprompts? You should also update the memory/glossary.md file to use this new name.
