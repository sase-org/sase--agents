- **PLAN:** [202607/dotfiles_ruff_markdown.md](https://github.com/sase-org/sase--plans/blob/main/202607/dotfiles_ruff_markdown.md)

 GitHub Actions is failing for the dotfiles repo. Can you run the `actstat` command to get more information about
