- **PLAN:** [202607/refresh_antigravity_gemini_models.md](https://github.com/sase-org/sase--plans/blob/main/202607/refresh_antigravity_gemini_models.md)

 I don't think the Antigravity models that we currently show in pickers
