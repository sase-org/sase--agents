- **PLAN:** [202607/artifact_store_lifecycle.md](https://github.com/sase-org/sase--plans/blob/main/202607/artifact_store_lifecycle.md)

 Can you help me implement the work associated with the "Give the store a lifecycle: report → dry-run → opt-in
