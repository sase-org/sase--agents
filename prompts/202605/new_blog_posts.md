- **PLAN:** [202605/new_blog_posts.md](https://github.com/sase-org/sase--plans/blob/main/202605/new_blog_posts.md)
...
- xprompts (intro + workflows + don't use workflows)
- axe
- beads / sdd
- commit xprompt workflows - plugins / public API
- ChangeSpecs (intro + mentors/fix_hook/crs + advanced TUI operations)
- Future work (memory + mobile/web)
