- **PLAN:**
  [202609/service_host_sunset_finish.md](https://github.com/sase-org/sase--plans/blob/main/202609/service_host_sunset_finish.md)
- **AGENTS:**
  - [bbugyi200.athena.sase-11y.10.1.land--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-11y.10.1.land.md)

You are the land agent for epic bead sase-11y.10.1: verify the epic is truly complete,
...
1. Verify. Run `sase bead show sase-11y.10.1` (children, linked plan file), review the
...
2. Integrate. Changes committed since this epic started could not integrate with this
   ...
   commit mentioning sase-11y.10.1, excluding the epic's own commits; in a PR workflow
...
3. Land. Unresolved issues caused by this epic remain epic work: plan and finish them
   ...
   close note. Before closing, run `sase bead epic-symbols sase-11y.10.1`. Every listed
   ...
   `sase bead close sase-11y.10.1 --note "<what you verified in steps 1-2>"`. After
...
`sase bead show sase-11y.10.1`. If there is no parent bead, finish normally. If the
