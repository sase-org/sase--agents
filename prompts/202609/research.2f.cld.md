- **AGENTS:**
  - [bbugyi200.athena.research.2f.cld](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.2f.cld/README.md)

%id(cld, clan=research.2f) %m:claude/opus@xhigh %q(w=0.25) #gh:gh_sase-org**sase You are
researcher cld in a 3-researcher swarm. The other researchers, `research.2f.mus`,
`research.2f.gem`, are independently investigating the same request and will write their
...
new recommended renames that you think I should perform (if any). #research(suffix=cld)
