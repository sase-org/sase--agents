- **AGENTS:**
  - [bbugyi200.athena.research.2d.gem](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.2d.gem/README.md)

%id(gem, clan=research.2d) %m:agy/gemini-3.8-flash-high %q(w=0.25) #gh:gh_sase-org**sase
You are researcher gem in a 3-researcher swarm. The other researchers,
`research.2d.cld`, `research.2d.mus`, are independently investigating the same request
