...
%id(cld, clan=research.1x) %m:@opus_or_grok %q(w=0.25) #gh:gh_sase-org**sase You are
researcher B in a two-researcher swarm. The other researcher, `research.1x.cdx`, is
...
I think I want to rename sase's AXE tab to "Schedule" and make a few other renames as
well.
