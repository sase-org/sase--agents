- **AGENTS:**
  - [bbugyi200.apollo.research.8.cld](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.apollo.research.8.cld/README.md)

%id(cld, clan=research.8) %m:claude/opus@xhigh %q(w=0.25) #gh:gh_sase-org**sase You are
researcher cld in a 4-researcher swarm. The other researchers, `research.8.cdx`,
