...
%id(cld, clan=research.4) %wait(priority=20) %m:@research_b #gh:gh_sase-org__sase I
would like to add the ability for users to add new projects in bulk from the "Projects"
tab on the "SASE Admin Center" panel.
