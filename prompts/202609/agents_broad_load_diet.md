- **PLAN:**
  [202609/agents_broad_load_diet.md](https://github.com/sase-org/sase--plans/blob/main/202609/agents_broad_load_diet.md)
- **AGENTS:**
  - [bbugyi200.athena.sase-124.4--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-124.4.md)

Can you complete the work for bead sase-124.4? The bead is already reserved for you and
...
`sase bead epic-symbols sase-124.4`. If this phase still has `--epic-symbol` entries,
...
`sase bead note sase-124.4 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the
