...
%clan(research.5, tribe=research, summary=[[[bold]RESEARCH PROMPT:[/bold] I've been
...
recommend is reliable and robust.]]) %id:research.5.cdx %wait(priority=20)
%model:@research_a #gh:gh_sase-org__sase I've been thinking about ways we could allow
sase to dispatch to other known machines so the user can open up one TUI on one machine
and manage all of their agents across all machines.
