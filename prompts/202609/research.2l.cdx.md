- **AGENTS:**
  - [bbugyi200.athena.research.2l.cdx](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.2l.cdx/README.md)

%id(cdx, clan=research.2l) %m:codex/gpt-5.6-sol@xhigh %q(1.5x, w=0.25)
#gh:gh_sase-org**sase You are researcher cdx in a 4-researcher swarm. The other
researchers, `research.2l.grk`, `research.2l.mus`, `research.2l.gem`, are independently
investigating the same request and will write their own self-named reports ending in
`**grk.md`and`**mus.md`and`**gem.md`. Your report will end in `__cdx.md`.
...
with a recommended solution. #research(suffix=cdx)
