- **AGENTS:**
  - [bbugyi200.athena.research.2i.cdx](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.2i.cdx/README.md)

%id(cdx, clan=research.2i) %m:codex/gpt-5.6-sol@xhigh %q(w=0.25) #gh:gh_sase-org**sase
You are researcher cdx in a 4-researcher swarm. The other researchers,
`research.2i.cld`, `research.2i.mus`, `research.2i.gem`, are independently investigating
...
likely to read this research). #research(suffix=cdx)
