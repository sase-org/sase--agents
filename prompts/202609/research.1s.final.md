- **AGENTS:**
  - [bbugyi200.athena.research.1s.final](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.1s.final/README.md)

%id(final, clan=research.1s) %m:@xlarge %wait:research.1s.cdx %wait:research.1s.cld
...
I want to start displaying useful information about an agent's finalizers when that
agent is selected in the "Agents" tab. For example, I want to make it easy for users to
