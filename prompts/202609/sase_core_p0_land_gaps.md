- **PLAN:**
  [202609/sase_core_p0_land_gaps.md](https://github.com/sase-org/sase--plans/blob/main/202609/sase_core_p0_land_gaps.md)
- **AGENTS:**
  - [bbugyi200.athena.sase-165.land--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-165.land.md)

You are the land agent for epic bead sase-165: verify the epic is truly complete,
...
1. Verify. Run
   `sase bead read sase-165 -r "Need the epic scope, children, and linked plan file"`,
...
2. Integrate. Changes committed since this epic started could not integrate with this
   ...
   commit mentioning sase-165, excluding the epic's own commits; in a PR workflow also
...
3. Land. Unresolved issues caused by this epic remain epic work: plan and finish them
   ...
   close note. Before closing, run `sase bead epic-symbols sase-165`. Every listed
   ...
   `sase bead close sase-165 --note "<what you verified in steps 1-2>"`. After closing,
...
`sase bead read sase-165 -r "Need the parent link"`. If there is no parent bead, finish
