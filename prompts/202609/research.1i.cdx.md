- **AGENTS:**
  - [bbugyi200.athena.research.1i.cdx](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.1i.cdx/README.md)

#gh:gh_sase-org__sase %clan(research.1i, tribe=research, summary=[[[bold]RESEARCH
PROMPT:[/bold] I want to add support to sase for dispatching to remote machines.
...
%model:@research_a You are researcher A in a two-researcher swarm. The other researcher,
