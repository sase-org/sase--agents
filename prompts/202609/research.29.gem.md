- **AGENTS:**
  - [bbugyi200.athena.research.29.gem](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.29.gem/README.md)

%id(gem, clan=research.29) %m:agy/gemini-3.8-flash-high %q(w=0.25) #gh:gh_sase-org**sase
You are researcher gem in a 3-researcher swarm. The other researchers,
`research.29.cld`, `research.29.mus`, are independently investigating the same request
