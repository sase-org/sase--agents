- **AGENTS:**
  - [bbugyi200.athena.research.1z.final](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.1z.final/README.md)

%id(final, clan=research.1z) %m:claude-fable-5 %wait:research.1z.cdx
%wait:research.1z.cld %q(w=0.25) #gh:gh_sase-org__sase You are the lead researcher:
