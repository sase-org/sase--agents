...
- **AGENTS:**
  - [bbugyi200.athena.sase-11l.5--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-11l.5.md)

Can you complete the work for bead sase-11l.5? The bead is already reserved for you and
...
`sase bead epic-symbols sase-11l.5`. If this phase still has `--epic-symbol` entries,
...
`sase bead note sase-11l.5 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the
