- **AGENTS:**
  - [bbugyi200.athena.research.2m.gem](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.2m.gem/README.md)

%id(gem, clan=research.2m) %m:agy/gemini-3.8-flash-high %q(1.5x, w=0.25)
#gh:gh_sase-org**sase You are researcher gem in a 4-researcher swarm. The other
researchers, `research.2m.cdx`, `research.2m.grk`, `research.2m.mus`, are independently
