- **PLAN:**
  [202609/artifact_link_cutover_import.md](https://github.com/sase-org/sase--plans/blob/main/202609/artifact_link_cutover_import.md)
- **AGENTS:**
  - [bbugyi200.athena.sase-yy.6--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-yy.6.md)
...
`sase bead epic-symbols sase-yy.6`. If this phase still has `--epic-symbol` entries,
...
`sase bead note sase-yy.6 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the epic's
