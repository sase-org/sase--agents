- **AGENTS:**
  - [bbugyi200.athena.research.21.final](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.21.final/README.md)

%id(final, clan=research.21) %m:@xlarge %wait:research.21.cdx %wait:research.21.cld
%q(10, w=0.25) #gh:gh_sase-org__sase You are the lead researcher: two independent
...
The `@epic` agent tribe panel still disappears and reappears (i.e. flickers) sometimes
on the "Agents" tab. We've tried to fix this several times before now. Can you do some
research with the goal of helping me figure out what's causing this / what we need to do
to mitigate this? End your analysis with a recommended solution. Make sure to organize
your contents appropriately using markdown sections.
