- **AGENTS:**
  - [bbugyi200.kellys_mbp.research.b.final](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.kellys_mbp.research.b.final/README.md)

%id(final, clan=research.b) %m:@xlarge %wait:research.b.cdx %wait:research.b.cld
...
1. From the registered reports above, identify the one distinct A report and the one
   distinct B report belonging to this dispatch's `research.b.cdx` and `research.b.cld`
