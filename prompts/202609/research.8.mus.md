- **AGENTS:**
  - [bbugyi200.apollo.research.8.mus](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.apollo.research.8.mus/README.md)

%id(mus, clan=research.8) %m:muse/muse-spark-1.3-contributor@xhigh %q(w=0.25)
#gh:gh_sase-org**sase You are researcher mus in a 4-researcher swarm. The other
researchers, `research.8.cdx`, `research.8.cld`, `research.8.gem`, are independently
