- **PLAN:**
  [202609/machine_cli_enrollment_1.md](https://github.com/sase-org/sase--plans/blob/main/202609/machine_cli_enrollment_1.md)
- **AGENTS:**
  - [bbugyi200.athena.sase-xe.8--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-xe.8.md)
...
`sase bead epic-symbols sase-xe.8`. If this phase still has `--epic-symbol` entries,
...
`sase bead note sase-xe.8 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the epic's
