- **AGENTS:**
  - [bbugyi200.apollo.research.f.gem](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.apollo.research.f.gem/README.md)

%id(gem, clan=research.f) %m:agy/gemini-3.8-flash-high %q(1.5x, w=0.25)
#gh:gh_sase-org**sase You are researcher gem in a 4-researcher swarm. The other
researchers, `research.f.cdx`, `research.f.grk`, `research.f.mus`, are independently
...
with a recommended solution. #research(suffix=gem)
