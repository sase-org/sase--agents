- **AGENTS:**
  - [bbugyi200.apollo.research.e.gem](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.apollo.research.e.gem/README.md)

%id(gem, clan=research.e) %m:agy/gemini-3.8-flash-high %q(1.5x, w=0.25)
#gh:gh_sase-org**sase You are researcher gem in a 5-researcher swarm. The other
researchers, `research.e.cdx`, `research.e.cld`, `research.e.grk`, `research.e.mus`, are
