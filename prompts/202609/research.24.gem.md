- **AGENTS:**
  - [bbugyi200.athena.research.24.gem](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.24.gem/README.md)

%id(gem, clan=research.24) %m:agy/gemini-3.8-flash-high %q(w=0.25) #gh:gh_sase-org**sase
You are researcher gem in a 3-researcher swarm. The other researchers,
`research.24.cld`, `research.24.mus`, are independently investigating the same request
...
- Think hard about what it means for Rust code to be easy to understand / maintain by
  sase agents. #research(suffix=gem)
