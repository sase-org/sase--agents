- **AGENTS:**
  - [bbugyi200.apollo.research.a.cld](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.apollo.research.a.cld/README.md)

%id(cld, clan=research.a) %m:claude/opus@xhigh %q(w=0.25) #gh:gh_sase-org**sase You are
researcher cld in a 4-researcher swarm. The other researchers, `research.a.cdx`,
...
`**cdx.md`and`**mus.md`and`**gem.md`. Your report will end in `__cld.md`.
...
analysis with a recommended solution. #research(suffix=cld)
