...
%id(final, clan=research.4) %wait(priority=20) %m:@research_lead %wait:research.4.cdx
%wait:research.4.cld #gh:gh_sase-org__sase You are the lead researcher: two
...
I would like to add the ability for users to add new projects in bulk from the
"Projects" tab on the "SASE Admin Center" panel.
...
1. Read both transcripts to learn which report file each researcher wrote
   (`research.4.cdx` -> `__a`, `research.4.cld` -> `__b`), then read both reports. Never
