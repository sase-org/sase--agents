- **AGENTS:**
  - [bbugyi200.apollo.research.8.cdx](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.apollo.research.8.cdx/README.md)

#gh:gh_sase-org__sase %id(cdx, clan=research.8) %m:codex/gpt-5.6-sol@xhigh %q(w=0.25)

You are researcher cdx in a 4-researcher swarm. The other researchers, `research.8.cld`,
`research.8.mus`, `research.8.gem`, are independently investigating the same request and
will write their own self-named reports ending in `__cld.md` and `__mus.md` and
`__gem.md`. Your report will end in `__cdx.md`.
