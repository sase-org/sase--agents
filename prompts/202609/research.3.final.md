- **AGENTS:**
  - [bbugyi200.apollo.research.3.final](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.apollo.research.3.final/README.md)

%id(final, clan=research.3) %m:claude-fable-5 %wait:research.3.cdx %wait:research.3.cld
...
1. From the registered reports above, identify the one distinct A report and the one
   distinct B report belonging to this dispatch's `research.3.cdx` and `research.3.cld`
