- **AGENTS:**
  - [bbugyi200.athena.0q8](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.0q8/README.md)

#gh:gh_sase-org__sase The Muse LLM provider is using its own harness to wait for
background commands.
