...
%clan(research.1g, tribe=research, summary=[[[bold]RESEARCH PROMPT:[/bold] I've been
thinking about ways we could allow sase to dispatch to other known machines so the user
can open up one TUI on one machine and manage all of their agents across all machines.
...
recommend is reliable, robust, and beautiful.]]) %id:research.1g.cdx %model:@research_a
#gh:gh_sase-org__sase I've been thinking about ways we could allow sase to dispatch to
other known machines so the user can open up one TUI on one machine and manage all of
...
#research(report_target=research.1g.cdx.md)
