- **AGENTS:**
  - [bbugyi200.athena.research.2j.mus](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.2j.mus/README.md)

%id(mus, clan=research.2j) %m:muse/muse-spark-1.3-contributor@xhigh %q(w=0.25)
#gh:gh_sase-org**sase You are researcher mus in a 4-researcher swarm. The other
researchers, `research.2j.cdx`, `research.2j.cld`, `research.2j.gem`, are independently
investigating the same request and will write their own self-named reports ending in
`**cdx.md`and`**cld.md`and`**gem.md`. Your report will end in `__mus.md`.
