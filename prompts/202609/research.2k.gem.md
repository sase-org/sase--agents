- **AGENTS:**
  - [bbugyi200.athena.research.2k.gem](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.2k.gem/README.md)

%id(gem, clan=research.2k) %m:agy/gemini-3.8-flash-high %q(w=0.25) #gh:gh_sase-org**sase
You are researcher gem in a 5-researcher swarm. The other researchers,
`research.2k.cdx`, `research.2k.cld`, `research.2k.grk`, `research.2k.mus`, are
...
easier. End your analysis with a recommended solution. #research(suffix=gem)
