- **PLAN:**
  [202609/verdict_completion.md](https://github.com/sase-org/sase--plans/blob/main/202609/verdict_completion.md)
- **AGENTS:**
  - [bbugyi200.athena.sase-1ah.6--plan](https://github.com/sase-org/sase--agents/blob/main/sessions/bbugyi200.athena.sase-1ah.6.md)

Can you complete the work for bead sase-1ah.6? The bead is already reserved for you and
...
file with `sase bead read sase-1ah.6 -r "Need the phase scope and design file"`, do the
work, and close only this bead with
`sase bead close sase-1ah.6 --note "<what you verified>"`. Before closing, run
`sase bead epic-symbols sase-1ah.6`. If this phase still has `--epic-symbol` entries,
...
`sase bead note sase-1ah.6 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the
