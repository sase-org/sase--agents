...
- **AGENTS:**
  - [bbugyi200.athena.sase-17m.5.1.land--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-17m.5.1.land.md)

You are the land agent for epic bead sase-17m.5.1: verify the epic is truly complete,
...
1. Verify. Run
   `sase bead read sase-17m.5.1 -r "Need the epic scope, children, and linked plan file"`,
...
2. Integrate. Changes committed since this epic started could not integrate with this
   ...
   commit mentioning sase-17m.5.1, excluding the epic's own commits; in a PR workflow
...
3. Land. Unresolved issues caused by this epic remain epic work: plan and finish them
   ...
   close note. Before closing, run `sase bead epic-symbols sase-17m.5.1`. Every listed
   ...
   `sase bead close sase-17m.5.1 --note "<what you verified in steps 1-2>"`. After
...
`sase bead read sase-17m.5.1 -r "Need the parent link"`. If there is no parent bead,
