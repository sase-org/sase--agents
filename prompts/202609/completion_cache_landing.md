- **PLAN:**
  [202609/completion_cache_landing.md](https://github.com/sase-org/sase--plans/blob/main/202609/completion_cache_landing.md)
- **AGENTS:**
  - [bbugyi200.apollo.sase-12o.land--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.apollo.sase-12o.land.md)

You are the land agent for epic bead sase-12o: verify the epic is truly complete,
integrate it with changes that landed since it started, then close it out.

1. Verify. Run `sase bead show sase-12o` (children, linked plan file), review the epic
...
2. Integrate. Changes committed since this epic started could not integrate with this
   ...
   commit mentioning sase-12o, excluding the epic's own commits; in a PR workflow also
...
3. Land. Unresolved issues caused by this epic remain epic work: plan and finish them
   ...
   close note. Before closing, run `sase bead epic-symbols sase-12o`. Every listed
   ...
   `sase bead close sase-12o --note "<what you verified in steps 1-2>"`. After closing,
...
`sase bead show sase-12o`. If there is no parent bead, finish normally. If the parent is
