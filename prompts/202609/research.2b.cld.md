- **AGENTS:**
  - [bbugyi200.athena.research.2b.cld](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.2b.cld/README.md)

%id(cld, clan=research.2b) %m:claude/opus@xhigh %q(w=0.25) #gh:gh_sase-org**sase You are
researcher cld in a 3-researcher swarm. The other researchers, `research.2b.mus`,
`research.2b.gem`, are independently investigating the same request and will write their
