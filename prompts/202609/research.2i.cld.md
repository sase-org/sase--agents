- **AGENTS:**
  - [bbugyi200.athena.research.2i.cld](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.2i.cld/README.md)

%id(cld, clan=research.2i) %m:claude/opus@xhigh %q(w=0.25) #gh:gh_sase-org**sase You are
researcher cld in a 4-researcher swarm. The other researchers, `research.2i.cdx`,
`research.2i.mus`, `research.2i.gem`, are independently investigating the same request
...
likely to read this research). #research(suffix=cld)
