- **AGENTS:**
  - [bbugyi200.athena.research.20.cdx](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.20.cdx/README.md)

%clan(research.20, tribe=research, summary=[[[bold]RESEARCH PROMPT:[/bold] I want to
generalize the "AXE" tab / `sase axe` command (soon to be renamed to "Supervisor" /
`sase supervisor`--this is how I shall refer to these from this point on).
...
improvements but clearly call these out. End your analysis with a recommended
solution.]]) %id:research.20.cdx %m:@sol_or_grok %q(w=0.25) #gh:gh_sase-org**sase You
are researcher A in a two-researcher swarm. The other researcher, `research.20.cld`, is
