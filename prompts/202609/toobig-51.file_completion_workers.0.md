...
%wait:toobig-51.fleet_agents.0 %id(file_completion_workers.0, clan=toobig-51)
%model:@medium %auto %wait(runners=3) %wait(priority=20) #gh:gh_sase-org__sase Can you
help me split the `src/sase/ace/tui/widgets/_file_completion_workers.py` file up into
