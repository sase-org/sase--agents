- **PLAN:**
  [202609/macos_ci_leg_green.md](https://github.com/sase-org/sase--plans/blob/main/202609/macos_ci_leg_green.md)
- **AGENTS:**
  - [bbugyi200.athena.sase-157.land--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-157.land.md)

You are the land agent for epic bead sase-157: verify the epic is truly complete,
...
1. Verify. Run `sase bead show sase-157` (children, linked plan file), review the epic
...
2. Integrate. Changes committed since this epic started could not integrate with this
   ...
   commit mentioning sase-157, excluding the epic's own commits; in a PR workflow also
...
3. Land. Unresolved issues caused by this epic remain epic work: plan and finish them
   ...
   close note. Before closing, run `sase bead epic-symbols sase-157`. Every listed
   ...
   `sase bead close sase-157 --note "<what you verified in steps 1-2>"`. After closing,
...
`sase bead show sase-157`. If there is no parent bead, finish normally. If the parent is
