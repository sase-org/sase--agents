- **PLAN:**
  [202609/federation_worker.md](https://github.com/sase-org/sase--plans/blob/main/202609/federation_worker.md)
- **AGENTS:**
  - [bbugyi200.athena.sase-xe.10--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-xe.10.md)
...
`sase bead epic-symbols sase-xe.10`. If this phase still has `--epic-symbol` entries,
...
`sase bead note sase-xe.10 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the
