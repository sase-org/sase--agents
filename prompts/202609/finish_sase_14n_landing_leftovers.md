- **PLAN:**
  [202609/finish_sase_14n_landing_leftovers.md](https://github.com/sase-org/sase--plans/blob/main/202609/finish_sase_14n_landing_leftovers.md)
- **AGENTS:**
  - [bbugyi200.athena.sase-14n.land--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-14n.land.md)

You are the land agent for epic bead sase-14n: verify the epic is truly complete,
...
1. Verify. Run
   `sase bead read sase-14n -r "Need the epic scope, children, and linked plan file"`,
...
2. Integrate. Changes committed since this epic started could not integrate with this
   ...
   commit mentioning sase-14n, excluding the epic's own commits; in a PR workflow also
...
3. Land. Unresolved issues caused by this epic remain epic work: plan and finish them
   ...
   close note. Before closing, run `sase bead epic-symbols sase-14n`. Every listed
   ...
   `sase bead close sase-14n --note "<what you verified in steps 1-2>"`. After closing,
...
`sase bead read sase-14n -r "Need the parent link"`. If there is no parent bead, finish
