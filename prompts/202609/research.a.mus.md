- **AGENTS:**
  - [bbugyi200.apollo.research.a.mus](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.apollo.research.a.mus/README.md)

%id(mus, clan=research.a) %m:muse/muse-spark-1.3-contributor@xhigh %q(w=0.25)
#gh:gh_sase-org**sase You are researcher mus in a 4-researcher swarm. The other
researchers, `research.a.cdx`, `research.a.cld`, `research.a.gem`, are independently
...
analysis with a recommended solution. #research(suffix=mus)
