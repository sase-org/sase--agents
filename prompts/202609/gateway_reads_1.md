- **PLAN:**
  [202609/gateway_reads_1.md](https://github.com/sase-org/sase--plans/blob/main/202609/gateway_reads_1.md)
- **AGENTS:**
  - [bbugyi200.athena.sase-xe.5--plan](https://github.com/sase-org/sase--agents/blob/main/families/bbugyi200.athena.sase-xe.5.md)
...
`sase bead epic-symbols sase-xe.5`. If this phase still has `--epic-symbol` entries,
...
`sase bead note sase-xe.5 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the epic's
