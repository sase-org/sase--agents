- **PLAN:**
  [202609/tui_turn_surfaces.md](https://github.com/sase-org/sase--plans/blob/main/202609/tui_turn_surfaces.md)
- **AGENTS:**
  - [bbugyi200.athena.sase-1ab.4--plan](https://github.com/sase-org/sase--agents/blob/main/sessions/bbugyi200.athena.sase-1ab.4.md)

Can you complete the work for bead sase-1ab.4? The bead is already reserved for you and
...
file with `sase bead read sase-1ab.4 -r "Need the phase scope and design file"`, do the
work, and close only this bead with
`sase bead close sase-1ab.4 --note "<what you verified>"`. Before closing, run
`sase bead epic-symbols sase-1ab.4`. If this phase still has `--epic-symbol` entries,
...
`sase bead note sase-1ab.4 'PROPOSED FOLLOW-UP: <one-line summary — detail>'`; the
