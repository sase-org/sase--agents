- **AGENTS:**
  - [bbugyi200.apollo.research.a.cdx](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.apollo.research.a.cdx/README.md)

%id(cdx, clan=research.a) %m:codex/gpt-5.6-sol@xhigh %q(w=0.25) #gh:gh_sase-org**sase
You are researcher cdx in a 4-researcher swarm. The other researchers, `research.a.cld`,
`research.a.mus`, `research.a.gem`, are independently investigating the same request and
...
analysis with a recommended solution. #research(suffix=cdx)
