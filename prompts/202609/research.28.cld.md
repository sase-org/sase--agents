- **AGENTS:**
  - [bbugyi200.athena.research.28.cld](https://github.com/sase-org/sase--agents/blob/main/agents/bbugyi200.athena.research.28.cld/README.md)

%id(cld, clan=research.28) %m:claude/opus@xhigh %q(w=0.25) #gh:gh_sase-org**sase You are
researcher cld in a 3-researcher swarm. The other researchers, `research.28.mus`,
`research.28.gem`, are independently investigating the same request and will write their
