...
%id(cld, clan=research.1t) %m:@opus_or_grok %q(w=0.25) #gh:gh_sase-org**sase You are
researcher B in a two-researcher swarm. The other researcher, `research.1t.cdx`, is
