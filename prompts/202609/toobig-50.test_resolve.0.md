...
%wait:toobig-50.test_app.0 %id(test_resolve.0, clan=toobig-50) %model:@medium %auto
%wait(runners=3) %wait(priority=20) #gh:gh_sase-org__sase Can you help me split the
`tests/pager/test_resolve.py` file up into multiple files? Use your best judgement, but
