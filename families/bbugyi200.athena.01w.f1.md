...
Owner: `bbugyi200.athena` · Hood: `01w` · Members: 3
...
flowchart TD
  ...
  n1["01w.f1--mon [active]"]
  n0 --> n1
  n2["01w.f1--code [active]"]
  n0 --> n2
```
...
| <a id="member-mon"></a>mon | 01w.f1--mon | active | gpt-5.5 / codex | 2026-08-15T00:22:26.926342+00:00 | 0 | — | — |
| <a id="member-code"></a>code | 01w.f1--code | active | gpt-5.5 / codex | 2026-08-15T00:14:06.824067+00:00 | [1](../agents/bbugyi200.athena.01w.f1--code/README.md#commits) | — | — |
...
|---|---|---|
| [01w](bbugyi200.athena.01w.md) (family · 4) | ancestor | completed 3, failed 1 |
