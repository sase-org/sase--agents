...
```mermaid
flowchart TD
  n0["sase-8t.3--plan [active]"]
  n1["sase-8t.3--code [completed]"]
  n0 --> n1
```
...
|---|---|---|---|---|
| code | sase | [`d0cf97a`](https://github.com/sase-org/sase/commit/d0cf97a12930b4c28e0f86097518cf05965ca306) | feat(axe): add whole-system status command (sase-8t.3) | 2026-07-23 13:05:49 UTC |
