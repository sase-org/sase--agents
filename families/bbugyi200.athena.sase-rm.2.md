...
```mermaid
flowchart TD
  n0["sase-rm.2--plan [active]"]
  n1["sase-rm.2--code [active]"]
  n0 --> n1
```
...
|---|---|---|---|---|---:|---|---|
| <a id="member-plan"></a>plan | sase-rm.2--plan | active | gpt-5.6-sol / codex | 2026-08-20T18:50:04.794994+00:00 | 0 | [Prompt](../agents/bbugyi200.athena.sase-rm.2--plan/prompt.md) | [Chat](../agents/bbugyi200.athena.sase-rm.2--plan/chat.md) |
| <a id="member-code"></a>code | sase-rm.2--code | active | grok-4.6 / grok | 2026-08-20T19:01:48.973966+00:00 | 0 | — | — |
