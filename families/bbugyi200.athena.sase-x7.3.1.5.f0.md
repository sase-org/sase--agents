...
flowchart TD
  ...
  n0 --> n1
  n2["sase-x7.3.1.5.f0--plan [active]"]
  n0 --> n2
```
...
| <a id="member-plan"></a>plan | sase-x7.3.1.5.f0--plan | active | gpt-6-astra / codex | 2026-09-06T17:11:50.124818+00:00 | 0 | [Prompt](../agents/bbugyi200.athena.sase-x7.3.1.5.f0--plan/prompt.md) | [Chat](../agents/bbugyi200.athena.sase-x7.3.1.5.f0--plan/chat.md) |
