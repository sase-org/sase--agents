...
flowchart TD
  ...
  n1["sase-ns.6.6.6.3--plan [dismissed]"]
  n0 --> n1
```
...
| <a id="member-plan"></a>plan | sase-ns.6.6.6.3--plan | dismissed | — | 2026-08-17T05:55:20 | 0 | — | — |

## Commits

| Role | Repo | Commit | Subject | Committed |
|---|---|---|---|---|
| code | sase | [`44df0bf`](https://github.com/sase-org/sase/commit/44df0bfb420c3fd2b291e7ed2aace67046fd0b0b) | test(monitor): deflake the supervise no-hang bounds | 2026-08-17 10:50:23 UTC |

## Neighbors

| Agent | Relation | State |
|---|---|---|
| [sase-ns.6.6.6.1](bbugyi200.athena.sase-ns.6.6.6.1.md) (family · 4) | sase-ns.6.6.6 hood | active 1, completed 2, failed 1 |
