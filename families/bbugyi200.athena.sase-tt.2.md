...
```mermaid
flowchart TD
  n0["sase-tt.2--1 [active]"]
  n1["sase-tt.2--2 [active]"]
  n0 --> n1
  n2["sase-tt.2--mon-0 [failed]"]
  n0 --> n2
  n3["sase-tt.2--plan [active]"]
  n0 --> n3
...
|---|---|---|---|---|---:|---|---|
| <a id="member-1"></a>1 | sase-tt.2--1 | active | sonnet / claude | 2026-08-25T20:14:48.907642+00:00 | 0 | [Prompt](../agents/bbugyi200.athena.sase-tt.2--1/prompt.md) | [Chat](../agents/bbugyi200.athena.sase-tt.2--1/chat.md) |
| <a id="member-2"></a>2 | sase-tt.2--2 | active | gpt-5.5 / codex | 2026-08-25T20:22:47.313456+00:00 | [1](../agents/bbugyi200.athena.sase-tt.2--2/README.md#commits) | [Prompt](../agents/bbugyi200.athena.sase-tt.2--2/prompt.md) | — |
...
| <a id="member-plan"></a>plan | sase-tt.2--plan | active | sonnet / claude | 2026-08-25T19:51:05.119905+00:00 | 0 | [Prompt](../agents/bbugyi200.athena.sase-tt.2--plan/prompt.md) | [Chat](../agents/bbugyi200.athena.sase-tt.2--plan/chat.md) |
...
| [sase-tt.land](bbugyi200.athena.sase-tt.land.md) (family · 5) | sase-tt hood | active 3, failed 2 |
