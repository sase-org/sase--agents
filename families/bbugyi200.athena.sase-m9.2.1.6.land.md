...
flowchart TD
  ...
  n0 --> n4
  n5["sase-m9.2.1.6.land--plan [active]"]
  n0 --> n5
```
...
| <a id="member-plan"></a>plan | sase-m9.2.1.6.land--plan | active | gpt-5.6-sol / codex | 2026-08-15T16:31:25.783706+00:00 | 0 | [Prompt](../agents/bbugyi200.athena.sase-m9.2.1.6.land--plan/prompt.md) | [Chat](../agents/bbugyi200.athena.sase-m9.2.1.6.land--plan/chat.md) |
...
| [sase-m9.2.1.6.3](bbugyi200.athena.sase-m9.2.1.6.3.md) (family · 3) | sase-m9.2.1.6 hood | active 1, completed 1, failed 1 |
