...
Owner: `bbugyi200.athena` · Hood: `sase-ns` · Members: 2 · Bead: [sase-ns.6.6.5](https://github.com/sase-org/sase--beads/blob/main/pages/sase-ns/sase-ns.6.6.5.md)

## Lineage

```mermaid
flowchart TD
  n0["sase-ns.6.6.5--plan [active]"]
  n1["sase-ns.6.6.5--code [active]"]
  n0 --> n1
```
...
| <a id="member-code"></a>code | sase-ns.6.6.5--code | active | sonnet / claude | 2026-08-17T08:39:28.336849+00:00 | [1](../agents/bbugyi200.athena.sase-ns.6.6.5--code/README.md#commits) | — | — |
...
| [sase-ns.6.6.4](bbugyi200.athena.sase-ns.6.6.4.md) (family · 4) | sase-ns.6.6 hood | active 1, completed 2, failed 1 |
