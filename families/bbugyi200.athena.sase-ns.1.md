...
Owner: `bbugyi200.athena` · Hood: `sase-ns` · Members: 2 · Bead: [sase-ns.1](https://github.com/sase-org/sase--beads/blob/main/pages/sase-ns/sase-ns.1.md)

## Lineage

```mermaid
flowchart TD
  n0["sase-ns.1--code [active]"]
  n1["sase-ns.1--plan [active]"]
  n0 --> n1
```
...
|---|---|---|---|---|---:|---|---|
| <a id="member-code"></a>code | sase-ns.1--code | active | sonnet / claude | 2026-08-16T21:28:04.850694+00:00 | 0 | — | — |
