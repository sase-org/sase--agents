...
```mermaid
flowchart TD
  n0["sase-um.9.land--gate [active]"]
  n1["sase-um.9.land--plan [active]"]
  n0 --> n1
  n2["sase-um.9.land--mon [active]"]
  n0 --> n2
```
...
|---|---|---|---|---|---:|---|---|
| <a id="member-gate"></a>gate | sase-um.9.land--gate | active | gpt-5.6-sol / codex | 2026-08-29T00:17:30.991687+00:00 | 0 | — | [Chat](../agents/bbugyi200.athena.sase-um.9.land--gate/chat.md) |
| <a id="member-plan"></a>plan | sase-um.9.land--plan | active | gpt-5.6-sol / codex | 2026-08-28T23:56:37.103811+00:00 | 0 | [Prompt](../agents/bbugyi200.athena.sase-um.9.land--plan/prompt.md) | [Chat](../agents/bbugyi200.athena.sase-um.9.land--plan/chat.md) |
| <a id="member-mon"></a>mon | sase-um.9.land--mon | active | gpt-5.6-sol / codex | 2026-08-29T00:17:41.580218+00:00 | 0 | — | — |
