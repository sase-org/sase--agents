...
```mermaid
flowchart TD
  n0["sase-h7.6--plan [active]"]
  n1["sase-h7.6--code [active]"]
  n0 --> n1
```
...
|---|---|---|---|---|---:|---|---|
| <a id="member-plan"></a>plan | sase-h7.6--plan | active | opus / claude | 2026-08-07T22:29:17.019703+00:00 | 0 | [Prompt](../agents/bbugyi200.athena.sase-h7.6--plan/prompt.md) | [Chat](../agents/bbugyi200.athena.sase-h7.6--plan/chat.md) |
| <a id="member-code"></a>code | sase-h7.6--code | active | sonnet / claude | 2026-08-07T22:41:21.656299+00:00 | 0 | — | — |
