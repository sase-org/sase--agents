...
```mermaid
flowchart TD
  n0["gy.f1.f8--plan [active]"]
  n1["gy.f1.f8--code [completed]"]
  n0 --> n1
```
...
|---|---|---|---|
| code | [`58bacaf`](https://github.com/sase-org/sase/commit/58bacaf668db5541554a49922203b828df9de916) | feat!: simplify phase model aliases | 2026-07-21 14:32:49 |
