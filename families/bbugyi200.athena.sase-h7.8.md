...
```mermaid
flowchart TD
  n0["sase-h7.8--code [active]"]
  n1["sase-h7.8--plan [active]"]
  n0 --> n1
```
...
|---|---|---|---|---|---:|---|---|
| <a id="member-code"></a>code | sase-h7.8--code | active | sonnet / claude | 2026-08-07T22:43:55.914730+00:00 | 0 | — | — |
| <a id="member-plan"></a>plan | sase-h7.8--plan | active | opus / claude | 2026-08-07T22:29:20.408844+00:00 | 0 | [Prompt](../agents/bbugyi200.athena.sase-h7.8--plan/prompt.md) | [Chat](../agents/bbugyi200.athena.sase-h7.8--plan/chat.md) |
