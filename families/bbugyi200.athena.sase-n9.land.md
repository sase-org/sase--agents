...
```mermaid
flowchart TD
  n0["sase-n9.land--plan [active]"]
  n1["sase-n9.land--code [completed]"]
  n0 --> n1
```
...
|---|---|---|---|---|---:|---|---|
| <a id="member-plan"></a>plan | sase-n9.land--plan | active | opus / claude | 2026-08-16T18:35:42.666571+00:00 | 0 | [Prompt](../agents/bbugyi200.athena.sase-n9.land--plan/prompt.md) | [Chat](../agents/bbugyi200.athena.sase-n9.land--plan/chat.md) |
| <a id="member-code"></a>code | sase-n9.land--code | completed | sonnet / claude | 2026-08-16T19:01:44.055659+00:00 | 0 | — | [Chat](../agents/bbugyi200.athena.sase-n9.land--code/chat.md) |

## Neighbors

| Agent | Relation | State |
|---|---|---|
| [sase-n9.1](bbugyi200.athena.sase-n9.1.md) (family · 7) | sase-n9 hood | active 1, completed 3, failed 3 |
