...
Owner: `bbugyi200.athena` · Hood: `sase-um` · Members: 3 · Bead: [sase-um.9.5.5](https://github.com/sase-org/sase--beads/blob/main/pages/sase-um/sase-um.9.5.5.md)

## Lineage

```mermaid
flowchart TD
  n0["sase-um.9.5.5--1 [active]"]
  n1["sase-um.9.5.5--plan [active]"]
  n0 --> n1
  n2["sase-um.9.5.5--mon [active]"]
  n0 --> n2
```
...
|---|---|---|---|---|---:|---|---|
| <a id="member-1"></a>1 | sase-um.9.5.5--1 | active | gpt-5.5 / codex | 2026-08-29T17:54:01.465283+00:00 | 0 | [Prompt](../agents/bbugyi200.athena.sase-um.9.5.5--1/prompt.md) | [Chat](../agents/bbugyi200.athena.sase-um.9.5.5--1/chat.md) |
| <a id="member-plan"></a>plan | sase-um.9.5.5--plan | active | gpt-5.5 / codex | 2026-08-29T17:40:37.446507+00:00 | 0 | [Prompt](../agents/bbugyi200.athena.sase-um.9.5.5--plan/prompt.md) | [Chat](../agents/bbugyi200.athena.sase-um.9.5.5--plan/chat.md) |
| <a id="member-mon"></a>mon | sase-um.9.5.5--mon | active | gpt-5.5 / codex | 2026-08-29T17:53:04.128632+00:00 | 0 | — | [Chat](../agents/bbugyi200.athena.sase-um.9.5.5--mon/chat.md) |
...
| [sase-um.9.5.4](bbugyi200.athena.sase-um.9.5.4.md) (family · 17) | sase-um.9.5 hood | active 17 |
