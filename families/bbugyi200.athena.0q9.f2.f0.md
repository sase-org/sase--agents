...
```mermaid
flowchart TD
  n0["0q9.f2.f0--code [active]"]
  n1["0q9.f2.f0--plan [active]"]
  n0 --> n1
  n2["0q9.f2.f0--gate [failed]"]
  n0 --> n2
```
...
|---|---|---|---|---|---:|---|---|
| <a id="member-code"></a>code | 0q9.f2.f0--code | active | muse-spark-1.3-contributor / muse | 2026-09-23T22:22:58.431908+00:00 | 0 | — | — |
...
|---|---|---|
| [0q9.f2](bbugyi200.athena.0q9.f2.md) (family · 5) | ancestor | completed 3, failed 2 |
| [0q9](bbugyi200.athena.0q9.md) (family · 3) | ancestor | completed 2, failed 1 |
