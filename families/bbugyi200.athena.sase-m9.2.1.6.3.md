...
```mermaid
flowchart TD
  n0["sase-m9.2.1.6.3--plan [completed]"]
...
|---|---|---|---|---|---:|---|---|
| <a id="member-plan"></a>plan | sase-m9.2.1.6.3--plan | completed | gpt-5.5 / codex | 2026-08-15T15:31:05.853024+00:00 | 0 | [Prompt](../agents/bbugyi200.athena.sase-m9.2.1.6.3--plan/prompt.md) | [Chat](../agents/bbugyi200.athena.sase-m9.2.1.6.3--plan/chat.md) |
...
| [sase-m9.2.1.6.land](bbugyi200.athena.sase-m9.2.1.6.land.md) (family · 4) | sase-m9.2.1.6 hood | active 1, completed 2, failed 1 |
