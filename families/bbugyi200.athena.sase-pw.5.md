...
Owner: `bbugyi200.athena` · Hood: `sase-pw` · Members: 3 · Bead: [sase-pw.5](https://github.com/sase-org/sase--beads/blob/main/pages/sase-pw/sase-pw.5.md)

## Lineage

```mermaid
flowchart TD
  n0["sase-pw.5--1 [active]"]
  n1["sase-pw.5--plan [completed]"]
  n0 --> n1
  n2["sase-pw.5--mon [failed]"]
  n0 --> n2
```
...
|---|---|---|---|---|---:|---|---|
| <a id="member-1"></a>1 | sase-pw.5--1 | active | grok-4.6 / grok | 2026-08-18T19:01:59.433369+00:00 | 0 | [Prompt](../agents/bbugyi200.athena.sase-pw.5--1/prompt.md) | — |
...
| [sase-pw.8](bbugyi200.athena.sase-pw.8.md) (family · 2) | sase-pw hood | active 1, completed 1 |
