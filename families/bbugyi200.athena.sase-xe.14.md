...
```mermaid
flowchart TD
  n0["sase-xe.14--gate [dismissed]"]
  n1["sase-xe.14--code [completed]"]
  n0 --> n1
  n2["sase-xe.14--plan [dismissed]"]
  n0 --> n2
```
...
|---|---|---|---|---|---:|---|---|
| <a id="member-gate"></a>gate | sase-xe.14--gate | dismissed | opus / claude | 2026-09-07T09:44:05.172772 → 2026-09-07T09:44:11 | 0 | — | — |
...
| <a id="member-plan"></a>plan | sase-xe.14--plan | dismissed | opus / claude | 2026-09-07T09:32:59.143798 → 2026-09-07T11:30:33.934978 | 0 | [Prompt](../agents/bbugyi200.athena.sase-xe.14--plan/prompt.md) | [Chat](../agents/bbugyi200.athena.sase-xe.14--plan/chat.md) |
