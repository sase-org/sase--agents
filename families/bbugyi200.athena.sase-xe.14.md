...
```mermaid
flowchart TD
  n0["sase-xe.14--gate [active]"]
  n1["sase-xe.14--code [completed]"]
  n0 --> n1
  n2["sase-xe.14--plan [active]"]
  n0 --> n2
```
...
|---|---|---|---|---|---:|---|---|
| <a id="member-gate"></a>gate | sase-xe.14--gate | active | opus / claude | 2026-09-07T13:44:05.172772+00:00 | 0 | — | [Chat](../agents/bbugyi200.athena.sase-xe.14--gate/chat.md) |
