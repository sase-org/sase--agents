...
```mermaid
flowchart TD
  n0["sase-p3.land--plan [failed]"]
  n1["sase-p3.land--mon [failed]"]
  n0 --> n1
```
...
|---|---|---|---|---|---:|---|---|
| <a id="member-plan"></a>plan | sase-p3.land--plan | failed | opus / claude | 2026-08-18T08:14:10.022720+00:00 | 0 | [Prompt](../agents/bbugyi200.athena.sase-p3.land--plan/prompt.md) | [Chat](../agents/bbugyi200.athena.sase-p3.land--plan/chat.md) |
| <a id="member-mon"></a>mon | sase-p3.land--mon | failed | opus / claude | 2026-08-18T08:37:32.642434+00:00 | 0 | — | [Chat](../agents/bbugyi200.athena.sase-p3.land--mon/chat.md) |
