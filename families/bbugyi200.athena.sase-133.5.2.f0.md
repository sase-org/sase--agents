...
```mermaid
flowchart TD
  n0["sase-133.5.2.f0--plan [active]"]
  n1["sase-133.5.2.f0--gate [active]"]
  n0 --> n1
```
...
|---|---|---|---|---|---:|---|---|
| <a id="member-plan"></a>plan | sase-133.5.2.f0--plan | active | opus / claude | 2026-09-20T12:31:15.064497+00:00 | 0 | [Prompt](../agents/bbugyi200.athena.sase-133.5.2.f0--plan/prompt.md) | [Chat](../agents/bbugyi200.athena.sase-133.5.2.f0--plan/chat.md) |
| <a id="member-gate"></a>gate | sase-133.5.2.f0--gate | active | opus / claude | 2026-09-20T13:02:14.339907+00:00 | 0 | — | — |
