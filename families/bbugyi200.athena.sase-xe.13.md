...
flowchart TD
  ...
  n1["sase-xe.13--plan [active]"]
  n0 --> n1
  n2["sase-xe.13--gate [active]"]
  n0 --> n2
```
...
| <a id="member-gate"></a>gate | sase-xe.13--gate | active | opus / claude | 2026-09-07T11:40:00.507896+00:00 | 0 | — | [Chat](../agents/bbugyi200.athena.sase-xe.13--gate/chat.md) |
