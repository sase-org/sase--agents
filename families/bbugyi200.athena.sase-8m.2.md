...
```mermaid
flowchart TD
  n0["sase-8m.2--plan [active]"]
  n1["sase-8m.2--code [active]"]
  n0 --> n1
```
...
|---|---|---|---|---|
| code | sase | [`331932b`](https://github.com/sase-org/sase/commit/331932b2c8c82517dd5920b5129822e50466079d) | feat(ace): add shared config editor components (sase-8m.2) | 2026-07-22 17:19:57 UTC |
