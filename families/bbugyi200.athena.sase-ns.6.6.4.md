...
Owner: `bbugyi200.athena` · Hood: `sase-ns` · Members: 2 · Bead: [sase-ns.6.6.4](https://github.com/sase-org/sase--beads/blob/main/pages/sase-ns/sase-ns.6.6.4.md)

## Lineage

```mermaid
flowchart TD
  n0["sase-ns.6.6.4--code [active]"]
...
|---|---|---|---|---|---:|---|---|
| <a id="member-code"></a>code | sase-ns.6.6.4--code | active | gpt-5.5 / codex | 2026-08-17T08:22:46.919509+00:00 | 0 | — | — |
...
| [sase-ns.6.6.5](../agents/bbugyi200.athena.sase-ns.6.6.5/README.md) | sase-ns.6.6 hood | active |
